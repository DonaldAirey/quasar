...
namespace MarkThree.Guardian.Core
{
    ...
    public class ClearingBroker : MarkThree.Guardian.Core.Broker
    {
        ...
        public new static void Insert(AdoTransaction adoTransaction)
        {
            ...
            Broker.Insert(adoTransaction);
            // These table lock(s) are required for the 'Insert' operation.
            adoTransaction.LockRequests.AddWriterLock(ServerMarketData.ClearingBrokerLock);
        }
        
        /// <summary>Inserts a ClearingBroker record using Metadata Parameters.</summary>
                    ...
                    object typeCode)
        {
            ...
            if ((typeCode == null))
            {
                typeCode = "Clearing Broker";
            }
            // Insert the base members using the base class.
            int clearingBrokerId = Broker.Insert(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, externalId2, externalId3, externalId4, externalId5, externalId6, externalId7, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, advertisementStylesheetId, destinationOrderDetailStylesheetId, destinationOrderStylesheetId, executionDetailStylesheetId, executionStylesheetId, matchStylesheetId, matchHistoryStylesheetId, partyTypeCode, sourceOrderDetailStylesheetId, sourceOrderStylesheetId, workingOrderStylesheetId, buyMarketValueThreshold, buyQuantityThreshold, sellMarketValueThreshold, sellQuantityThreshold, shortName, connected, phone, symbol, typeCode);
            // Increment the row version
            rowVersion = ServerMarketData.RowVersion.Increment();
            // Insert the record into the ADO database.
            ServerMarketData.ClearingBrokerRow clearingBrokerRow = clearingBrokerTable.NewClearingBrokerRow();
            clearingBrokerRow[clearingBrokerTable.RowVersionColumn] = rowVersion;
            clearingBrokerRow[clearingBrokerTable.ClearingBrokerIdColumn] = clearingBrokerId;
            clearingBrokerTable.AddClearingBrokerRow(clearingBrokerRow);
            adoTransaction.DataRows.Add(clearingBrokerRow);
            // Insert the record into the SQL database.
            SqlCommand sqlCommand = new SqlCommand("insert \"ClearingBroker\" (\"rowVersion\",ClearingBrokerId) values (@rowVersion,@clea" +
                    "ringBrokerId)");
            sqlCommand.Connection = sqlTransaction.Connection;
            sqlCommand.Transaction = sqlTransaction;
            sqlCommand.Parameters.Add(new SqlParameter("@rowVersion", SqlDbType.BigInt, 0, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Current, rowVersion));
            sqlCommand.Parameters.Add(new SqlParameter("@clearingBrokerId", SqlDbType.Int, 0, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Current, clearingBrokerId));
            sqlCommand.ExecuteNonQuery();
            // Return Statements
            return clearingBrokerRow.ClearingBrokerId;
        }
        ...
        /// <param name="phone">The value for the Phone column.</param>
        /// <param name="symbol">The value for the Symbol column.</param>
        /// <param name="clearingBrokerId">The value for the ClearingBrokerId column.</param>
        /// <param name="shortName">The value for the ShortName column.</param>
        /// <param name="typeCode">The value for the TypeCode column.</param>
                    ...
                    object typeCode)
        {
            ...
            {
                throw new Exception(string.Format("The ClearingBroker table does not have an element identified by {0}", clearingBrokerId));
            }
            // Rule #2: Optimistic Concurrency Check
            if ((clearingBrokerRow.RowVersion != rowVersion))
            {
        ...
        public new static void Delete(ParameterList parameters)
        {
            ...
            int clearingBrokerId = parameters["clearingBrokerId"];
            // Call the internal method to complete the operation.
            ClearingBroker.Delete(adoTransaction, sqlTransaction, rowVersion, clearingBrokerId);
        }
        
        /// <summary>Deletes a ClearingBroker record.</summary>
        /// <param name="transaction">Commits or rejects a set of commands as a unit</param>
        /// <param name="rowVersion">The version number of this row.</param>
        /// <param name="clearingBrokerId">The value for the ClearingBrokerId column.</param>
        /// <param name="archive">true to archive the object, false to unarchive it.</param>
        public new static void Delete(AdoTransaction adoTransaction, SqlTransaction sqlTransaction, long rowVersion, int clearingBrokerId)
        {
            // Accessor for the ClearingBroker Table.
            ServerMarketData.ClearingBrokerDataTable clearingBrokerTable = ServerMarketData.ClearingBroker;
            // Rule #1: Make sure the record exists before updating it.
            ...
            // by the top level type in the hierarchy, it is bypassed after you pass the first test.
            long baseRowVersion = clearingBrokerRow.BrokerRow.RowVersion;
            Broker.Delete(adoTransaction, sqlTransaction, baseRowVersion, clearingBrokerId);
        }
        
        /// <summary>DeleteChildrens a ClearingBroker record.</summary>
        /// <param name="transaction">Commits or rejects a set of commands as a unit</param>
        /// <param name="rowVersion">the version number of this row.</param>
        /// <param name="clearingBrokerId">The value for the ClearingBrokerId column.</param>
        /// <param name="archive">true to archive the object, false to unarchive it.</param>
        internal new static void DeleteChildren(AdoTransaction adoTransaction, SqlTransaction sqlTransaction, long rowVersion, int clearingBrokerId)
        {
            // Accessor for the ClearingBroker Table.
            ServerMarketData.ClearingBrokerDataTable clearingBrokerTable = ServerMarketData.ClearingBroker;
            ...
            clearingBrokerRow[clearingBrokerTable.RowVersionColumn] = rowVersion;
            adoTransaction.DataRows.Add(clearingBrokerRow);
            clearingBrokerRow.Delete();
            // Delete the record in the SQL database.
            SqlCommand sqlCommand = new SqlCommand("update \"ClearingBroker\" set \"IsDeleted\" = 1 where \"ClearingBrokerId\"=@clearingBro" +
                    "kerId");
            sqlCommand.Connection = sqlTransaction.Connection;
            sqlCommand.Transaction = sqlTransaction;
            sqlCommand.Parameters.Add(new SqlParameter("@clearingBrokerId", SqlDbType.Int, 0, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Current, clearingBrokerId));
        ...
        public new static void Archive(ParameterList parameters)
        {
            ...
            int clearingBrokerId = parameters["clearingBrokerId"];
            // Call the internal method to complete the operation.
            ClearingBroker.Archive(adoTransaction, sqlTransaction, rowVersion, clearingBrokerId);
        }
        
        /// <summary>Archives a ClearingBroker record.</summary>
        /// <param name="transaction">Commits or rejects a set of commands as a unit</param>
        /// <param name="rowVersion">The version number of this row.</param>
        /// <param name="clearingBrokerId">The value for the ClearingBrokerId column.</param>
        /// <param name="archive">true to archive the object, false to unarchive it.</param>
        public new static void Archive(AdoTransaction adoTransaction, SqlTransaction sqlTransaction, long rowVersion, int clearingBrokerId)
        {
            // Accessor for the ClearingBroker Table.
            ServerMarketData.ClearingBrokerDataTable clearingBrokerTable = ServerMarketData.ClearingBroker;
            // Rule #1: Make sure the record exists before updating it.
            ...
            // by the top level type in the hierarchy, it is bypassed after you pass the first test.
            long baseRowVersion = clearingBrokerRow.BrokerRow.RowVersion;
            Broker.Archive(adoTransaction, sqlTransaction, baseRowVersion, clearingBrokerId);
        }
        
        /// <summary>ArchiveChildrens a ClearingBroker record.</summary>
        /// <param name="transaction">Commits or rejects a set of commands as a unit</param>
        /// <param name="rowVersion">the version number of this row.</param>
        /// <param name="clearingBrokerId">The value for the ClearingBrokerId column.</param>
        /// <param name="archive">true to archive the object, false to unarchive it.</param>
        internal new static void ArchiveChildren(AdoTransaction adoTransaction, SqlTransaction sqlTransaction, long rowVersion, int clearingBrokerId)
        {
            // Accessor for the ClearingBroker Table.
            ServerMarketData.ClearingBrokerDataTable clearingBrokerTable = ServerMarketData.ClearingBroker;
            // This record can be used to iterate through all the children.
            ...
            SqlCommand sqlCommand = new SqlCommand("update \"ClearingBroker\" set \"IsArchived\" = 1 where \"ClearingBrokerId\"=@clearingBr" +
                    "okerId");
            sqlCommand.Connection = sqlTransaction.Connection;
            sqlCommand.Transaction = sqlTransaction;
            sqlCommand.Parameters.Add(new SqlParameter("@clearingBrokerId", SqlDbType.Int, 0, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Current, clearingBrokerId));
