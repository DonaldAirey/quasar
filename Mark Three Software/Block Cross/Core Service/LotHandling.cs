...
namespace MarkThree.Guardian.Core
{
    ...
    public class LotHandling
    {
        ...
        public static void Insert(AdoTransaction adoTransaction)
        {
            ...
            adoTransaction.LockRequests.AddWriterLock(ServerMarketData.LotHandlingLock);
        }
        ...
        public static void Insert(ParameterList parameters)
        {
            ...
            LotHandling.Insert(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, externalId2, externalId3, lotHandlingCode, mnemonic);
            // Return values.
        ...
        public static void Update(ParameterList parameters)
        {
            ...
            // Call the internal method to complete the operation.
            LotHandling.Update(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, externalId2, externalId3, lotHandlingCode, mnemonic);
            // Return values.
            parameters["rowVersion"] = rowVersion;
        }
