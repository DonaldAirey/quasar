...
namespace MarkThree.Guardian.Core
{
    ...
    public class Object
    {
                    ...
                    object worldPermission)
        {
            ...
            ServerMarketData.ObjectRow objectRow = objectTable.NewObjectRow();
        ...
        public static void Delete(AdoTransaction adoTransaction, SqlTransaction sqlTransaction, long rowVersion, int objectId)
        {
            ...
            for (int index = 0; (index < objectRow.GetObjectTreeRowsByObjectObjectTreeChildId().Length); index = (index + 1))
            {
                ...
                ObjectTree.Delete(adoTransaction, sqlTransaction, childObjectTreeRow.RowVersion, childObjectTreeRow.ObjectTreeId);
            }
