...
namespace MarkThree.Guardian.Core
{
    ...
    public class Position
    {
        ...
        public static void Insert(AdoTransaction adoTransaction)
        {
            ...
            adoTransaction.LockRequests.AddWriterLock(ServerMarketData.PositionLock);
        }
        ...
        public static void Insert(ParameterList parameters)
        {
            ...
            Position.Insert(adoTransaction, sqlTransaction, ref rowVersion, accountId, positionTypeCode, securityId, userData0, userData1, userData2, userData3, userData4, userData5, userData6, userData7);
            // Return values.
        ...
        public static void Update(ParameterList parameters)
        {
            ...
            object userData7 = parameters["userData7"].Value;
            // Call the internal method to complete the operation.
            Position.Update(adoTransaction, sqlTransaction, ref rowVersion, accountId, positionTypeCode, securityId, userData0, userData1, userData2, userData3, userData4, userData5, userData6, userData7);
            // Return values.
            parameters["rowVersion"] = rowVersion;
        }
        ...
        public static void Delete(ParameterList parameters)
        {
            ...
            int securityId = parameters["securityId"];
            // Call the internal method to complete the operation.
            Position.Delete(adoTransaction, sqlTransaction, rowVersion, accountId, positionTypeCode, securityId);
        }
        ...
        public static void Delete(AdoTransaction adoTransaction, SqlTransaction sqlTransaction, long rowVersion, int accountId, int positionTypeCode, int securityId)
        {
            // Accessor for the Position Table.
            ServerMarketData.PositionDataTable positionTable = ServerMarketData.Position;
            // Rule #1: Make sure the record exists before updating it.
            ...
            SqlCommand sqlCommand = new SqlCommand("update \"Position\" set \"IsDeleted\" = 1 where \"AccountId\"=@accountId and \"PositionT" +
                    "ypeCode\"=@positionTypeCode and \"SecurityId\"=@securityId");
            sqlCommand.Connection = sqlTransaction.Connection;
            sqlCommand.Transaction = sqlTransaction;
            sqlCommand.Parameters.Add(new SqlParameter("@accountId", SqlDbType.Int, 0, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Current, accountId));
            sqlCommand.Parameters.Add(new SqlParameter("@positionTypeCode", SqlDbType.Int, 0, ParameterDirection.Input, false, 0, 0, null, DataRowVersion.Current, positionTypeCode));
        ...
        public static void Archive(ParameterList parameters)
        {
            ...
            int securityId = parameters["securityId"];
            // Call the internal method to complete the operation.
            Position.Archive(adoTransaction, sqlTransaction, rowVersion, accountId, positionTypeCode, securityId);
        }
