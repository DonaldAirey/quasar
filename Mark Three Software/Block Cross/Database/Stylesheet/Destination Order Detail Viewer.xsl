...
<stylesheet version="1.0" xmlns="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- These parameters are used by the loader to specify the attributes of the stylesheet. -->
 	<mts:stylesheetId>DESTINATION ORDER DETAIL VIEWER</mts:stylesheetId>
	<mts:stylesheetTypeCode>DESTINATION ORDER DETAIL</mts:stylesheetTypeCode>
	<mts:name>Destination Order Detail Viewer</mts:name>  
				...
				<ss:Worksheet ss:Name="Sheet1">
					...
					<ss:Table mts:HeaderHeight="12.5">
						...
						<ss:Columns>
							...
							<ss:Column mts:ColumnId="LastPrice" ss:Hidden="1" ss:Width="40" ss:StyleID="TopRightText" mts:Printed="false" mts:Description="Last"/>
							...
							<ss:Column mts:ColumnId="CreatedTime" ss:Hidden="1" ss:Width="68" ss:StyleID="TopDateTime" mts:PrintWidth="65" mts:Description="Time"/>
							...
							<ss:Column mts:ColumnId="MarketValue" ss:Width="55" ss:StyleID="MarketValue" mts:Printed="false"  mts:Description="Net" />
						...
						<mts:View>
							<mts:ViewColumn mts:ColumnId="DestinationOrderId" mts:Direction="ascending" />
						</mts:View>
