...
execute "ObjectProlog" "TimeInForce"
go

/* Revision 1 */

if ("dbo"."RevisionNeeded" ('TimeInForce', 1) = 1)
begin
	...
	execute "RemoveObject" "TimeInForce"
	...
	execute ('
		ALTER TABLE "TimeInForce" WITH NOCHECK ADD 
			CONSTRAINT "PKTimeInForce" PRIMARY KEY  CLUSTERED 
			(
				"TimeInForceCode"
			)  ON "PRIMARY" 
	')
	...
	execute ('Update "VersionControl" set "Revision" = 1 where "Name" = ''TimeInForce''')
...
execute "ObjectEpilog" "TimeInForce"
go
