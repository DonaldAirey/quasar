...
/*
	execute ('
		...
		union select ''Version 1.0'', ''AddWorkingOrderTree'', 1
		union select ''Version 1.0'', ''AddBlotter'', 1
		union select ''Version 1.0'', ''AddFolder'', 1
		union select ''Version 1.0'', ''AddLogin'', 1
		...
		union select ''Version 1.0'', ''DeleteWorkingOrder'', 1
		...
		union select ''Version 1.0'', ''GetWorkingOrder'', 1
		union select ''Version 1.0'', ''GetWorkingOrderTree'', 1
		...
		union select ''Version 1.0'', ''GetLogin'', 1
		...
		union select ''Version 1.0'', ''GetDestinationOrder'', 1
		...
		union select ''Version 1.0'', ''InsertWorkingOrder'', 1
		...
		union select ''Version 1.0'', ''InsertLoginExternal'', 1
		...
		union select ''Version 1.0'', ''WorkingOrder'', 1
		union select ''Version 1.0'', ''WorkingOrderTree'', 0
		...
		union select ''Version 1.0'', ''Login'', 1
		...
		union select ''Version 1.0'', ''DestinationOrder'', 1
