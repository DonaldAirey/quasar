...
namespace MarkThree.Guardian.External
{
    ...
    public class Account : AccountBase
    {
        ...
        public new static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.Account.Insert(adoTransaction);
            MarkThree.Guardian.Core.Account.Update(adoTransaction);
            ...
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.LotHandlingLock);
        }
        ...
        public new static void Load(ParameterList parameters)
        {
            ...
            int accountId = AccountBase.FindKey(configurationId, "accountId", externalAccountId);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Account.Delete(adoTransaction);
        ...
        public new static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(accountRow[accountTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.Account.Delete(adoTransaction, sqlTransaction, rowVersion, accountId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Account.Archive(adoTransaction);
        ...
        public new static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(accountRow[accountTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.Account.Archive(adoTransaction, sqlTransaction, rowVersion, accountId);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
