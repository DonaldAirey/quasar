...
namespace MarkThree.Guardian.External
{
    ...
    public class Broker : Source
    {
        ...
        public new static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.Broker.Insert(adoTransaction);
            MarkThree.Guardian.Core.Broker.Update(adoTransaction);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Broker.Delete(adoTransaction);
        ...
        public new static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(brokerRow[brokerTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.Broker.Delete(adoTransaction, sqlTransaction, rowVersion, brokerId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Broker.Archive(adoTransaction);
