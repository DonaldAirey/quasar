...
namespace MarkThree.Guardian.External
{
    ...
    public class BrokerAccount
    {
        ...
        static BrokerAccount()
        {
            // The table must be locked before the indices can be read into an accelerator array.
            ServerMarketData.BrokerAccountLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            BrokerAccount.externalKeyArray = new DataView[] {
                    brokerAccountTable.KeyBrokerAccountExternalId0,
                    brokerAccountTable.KeyBrokerAccountExternalId1,
                    brokerAccountTable.KeyBrokerAccountExternalId2,
                    brokerAccountTable.KeyBrokerAccountExternalId3};
            // The table must be released after the array is constructed.
            ServerMarketData.BrokerAccountLock.ReleaseReaderLock();
        }
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.BrokerAccount.Insert(adoTransaction);
            MarkThree.Guardian.Core.BrokerAccount.Update(adoTransaction);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.BrokerAccount.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.BrokerAccountLock);
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.ConfigurationLock);
        }
        
        /// <summary>Deletes a BrokerAccount record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(brokerAccountRow[brokerAccountTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.BrokerAccount.Delete(adoTransaction, sqlTransaction, rowVersion, brokerAccountId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.BrokerAccount.Archive(adoTransaction);
