...
namespace MarkThree.Guardian.External
{
    ...
    public class Province
    {
        ...
        static Province()
        {
            ...
            ServerMarketData.ProvinceLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            Province.externalKeyArray = new DataView[] {
                    provinceTable.KeyProvinceExternalId0,
                    provinceTable.KeyProvinceExternalId1};
            // The table must be released after the array is constructed.
            ServerMarketData.ProvinceLock.ReleaseReaderLock();
        }
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.Province.Insert(adoTransaction);
            MarkThree.Guardian.Core.Province.Update(adoTransaction);
        ...
        public static void Load(ParameterList parameters)
        {
            ...
            if ((provinceId == int.MinValue))
            {
                ...
                MarkThree.Guardian.Core.Province.Insert(adoTransaction, sqlTransaction, ref rowVersion, abbreviation, countryId, externalId0, externalId1, name);
            }
            else
            {
                ...
                // Call the internal method to complete the operation.
                MarkThree.Guardian.Core.Province.Update(adoTransaction, sqlTransaction, ref rowVersion, abbreviation, countryId, externalId0, externalId1, name, provinceId);
            }
            // Return values.
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Province.Delete(adoTransaction);
        ...
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(provinceRow[provinceTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.Province.Delete(adoTransaction, sqlTransaction, rowVersion, provinceId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Province.Archive(adoTransaction);
