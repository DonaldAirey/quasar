...
namespace MarkThree.Guardian.External
{
    ...
    public class Status
    {
        ...
        static Status()
        {
            ...
            ServerMarketData.StatusLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            Status.externalKeyArray = new DataView[] {
                    statusTable.KeyStatusExternalId0,
                    statusTable.KeyStatusExternalId1,
                    statusTable.KeyStatusExternalId2,
                    statusTable.KeyStatusExternalId3};
            // The table must be released after the array is constructed.
            ServerMarketData.StatusLock.ReleaseReaderLock();
        }
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.Status.Insert(adoTransaction);
            MarkThree.Guardian.Core.Status.Update(adoTransaction);
        ...
        public static void Load(ParameterList parameters)
        {
            ...
            if ((statusRow == null))
            {
                ...
                MarkThree.Guardian.Core.Status.Insert(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, externalId2, externalId3, mnemonic, statusCode);
            }
            else
            {
                ...
                MarkThree.Guardian.Core.Status.Update(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, externalId2, externalId3, mnemonic, statusCode);
            }
            // Return values
        ...
        public static void Update(ParameterList parameters)
        {
            ...
            MarkThree.Guardian.Core.Status.Update(adoTransaction, sqlTransaction, ref rowVersion, description, null, null, null, null, mnemonic, statusCode);
            // Return values.
            parameters["rowVersion"] = rowVersion;
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Status.Delete(adoTransaction);
        ...
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(statusRow[statusTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.Status.Delete(adoTransaction, sqlTransaction, rowVersion, statusCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Status.Archive(adoTransaction);
        ...
        public static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(statusRow[statusTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.Status.Archive(adoTransaction, sqlTransaction, rowVersion, statusCode);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
