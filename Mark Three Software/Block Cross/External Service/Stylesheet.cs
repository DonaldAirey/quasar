...
namespace MarkThree.Guardian.External
{
    ...
    public class Stylesheet
    {
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.Stylesheet.Insert(adoTransaction);
            MarkThree.Guardian.Core.Stylesheet.Update(adoTransaction);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Stylesheet.Delete(adoTransaction);
        ...
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(stylesheetRow[stylesheetTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.Stylesheet.Delete(adoTransaction, sqlTransaction, rowVersion, stylesheetId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Stylesheet.Archive(adoTransaction);
