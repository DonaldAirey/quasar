...
namespace MarkThree.Guardian.External
{
    ...
    public class VolumeCategory
    {
        ...
        static VolumeCategory()
        {
            // The table must be locked before the indices can be read into an accelerator array.
            ServerMarketData.VolumeCategoryLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            VolumeCategory.externalKeyArray = new DataView[] {
                    volumeCategoryTable.KeyVolumeCategoryExternalId0};
            // The table must be released after the array is constructed.
            ServerMarketData.VolumeCategoryLock.ReleaseReaderLock();
        }
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.VolumeCategory.Insert(adoTransaction);
            MarkThree.Guardian.Core.VolumeCategory.Update(adoTransaction);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.VolumeCategory.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.VolumeCategoryLock);
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.ConfigurationLock);
        }
        
        /// <summary>Deletes a VolumeCategory record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(volumeCategoryRow[volumeCategoryTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.VolumeCategory.Delete(adoTransaction, sqlTransaction, rowVersion, volumeCategoryId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.VolumeCategory.Archive(adoTransaction);
