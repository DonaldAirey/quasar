namespace MarkThree.MiddleTier
{
	...
	class TableChildRelationProperty : CodeMemberProperty
	{
		...
		public TableChildRelationProperty(KeyrefSchema keyrefSchema)
		{

			//			/// <summary>
			//			/// Gets the child relation between the Department and Employee tables.
			//			/// </summary>
			...
			this.Comments.Add(new CodeCommentStatement(string.Format("Gets the child relation between the {0} and {1} tables.", keyrefSchema.Refer.Selector.Name, keyrefSchema.Selector.Name), true));
			this.Comments.Add(new CodeCommentStatement("</summary>", true));
