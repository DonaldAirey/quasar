namespace MarkThree.Forms
{
	...
	public class ViewerRightBorder : ViewerBorder
	{
		...
		public ViewerRightBorder(Brush brush) : base(brush) { }
		...
		public ViewerRightBorder(Color color) : base(color) { }
		...
		public ViewerRightBorder(Color color, Single width) : base(color, width) { }
		...
		/// <param name="color">The color of the pen to use to draw the border.</param>
		/// <param name="width">The width of the border.</param>
		public ViewerRightBorder(Brush brush, Single width) : base(brush, width) { }
		...
		public override ViewerAttribute Clone()
		{
			...
			return new ViewerRightBorder(this.Brush.Clone() as Brush, this.Width);
