...
namespace MarkThree.Guardian.Core
{
    ...
    public class Currency : MarkThree.Guardian.Core.Security
    {
                    ...
                    object typeCode)
        {
            ...
            ServerMarketData.CurrencyRow currencyRow = currencyTable.NewCurrencyRow();
        ...
        public new static void Update(ParameterList parameters)
        {
            ...
            object typeCode = parameters["typeCode"].Value;
            // Call the internal method to complete the operation.
            Currency.Update(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, externalId2, externalId3, externalId4, externalId5, externalId6, externalId7, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, averageDailyVolume, countryId, minimumQuantity, marketCapitalization, symbol, logo, volumeCategoryId, currencyId, priceFactor, quantityFactor, typeCode);
            // Return values.
            parameters["rowVersion"] = rowVersion;
        }
