...
namespace MarkThree.Guardian.Core
{
    ...
    public class SystemFolder : MarkThree.Guardian.Core.Folder
    {
        ...
        public new static void Insert(AdoTransaction adoTransaction)
        {
            ...
            adoTransaction.LockRequests.AddWriterLock(ServerMarketData.SystemFolderLock);
        }
                    ...
                    object typeCode)
        {
            ...
            ServerMarketData.SystemFolderRow systemFolderRow = systemFolderTable.NewSystemFolderRow();
        ...
        internal new static void DeleteChildren(AdoTransaction adoTransaction, SqlTransaction sqlTransaction, long rowVersion, int systemFolderId)
        {
            ...
            {
                ServerMarketData.UserRow childUserRow = systemFolderRow.GetUserRows()[index];
