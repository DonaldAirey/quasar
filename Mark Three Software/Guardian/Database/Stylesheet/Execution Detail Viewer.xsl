...
<stylesheet version="1.0" xmlns="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- These parameters are used by the loader to specify the attributes of the stylesheet. -->
 	<mts:stylesheetId>EXECUTION DETAIL VIEWER</mts:stylesheetId>
	<mts:stylesheetTypeCode>EXECUTION DETAIL</mts:stylesheetTypeCode>
	<mts:name>Execution Detail Viewer</mts:name>  
      ...
      <if test="@ExecutionPrice">
        <ss:Cell mts:ColumnId="ExecutionPrice">
          ...
          <ss:Data ss:Type="decimal">
            <value-of select="@ExecutionPrice" />
          </ss:Data>
        </ss:Cell>
      </if>
