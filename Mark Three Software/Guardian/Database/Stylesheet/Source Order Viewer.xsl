...
<stylesheet version="1.0" xmlns="http://www.w3.org/1999/XSL/Transform"
	...
	<!-- These parameters are used by the loader to specify the attributes of the stylesheet. -->
 	<mts:stylesheetId>SOURCE ORDER VIEWER</mts:stylesheetId>
	<mts:stylesheetTypeCode>SOURCE ORDER</mts:stylesheetTypeCode>
	<mts:name>Source Order Viewer</mts:name>  
				...
				<ss:Worksheet ss:Name="Sheet1">
					...
					<ss:Table mts:HeaderHeight="12.5">
						...
						<ss:Columns>
							...
							<ss:Column mts:ColumnId="OmsFixNote" ss:Width="60" ss:StyleID="TopLeftText" mts:Printed="false"  mts:Description="OMS Fix Note" />
							...
							<ss:Column mts:ColumnId="UnfilledQuantity" ss:Width="50" ss:StyleID="TopRightText" mts:Printed="false"  mts:Description="UnfilledQuantity" />
						</ss:Columns>
