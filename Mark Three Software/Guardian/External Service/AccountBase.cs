...
namespace MarkThree.Guardian.External
{
    ...
    public class AccountBase : Object
    {
        ...
        public new static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.AccountBase.Insert(adoTransaction);
            MarkThree.Guardian.Core.AccountBase.Update(adoTransaction);
        ...
        /// <summary>Loads a AccountBase record using Metadata Parameters.</summary>
        ...
        public new static void Load(ParameterList parameters)
        {
            ...
            int accountBaseId = Object.FindKey(configurationId, "accountBaseId", externalAccountBaseId);
            ...
            if ((accountBaseRow == null))
            {
                ...
                int externalKeyIndex = AccountBase.GetExternalKeyIndex(configurationId, "accountBaseId");
                object[] externalIdArray = new object[8];
                externalIdArray[externalKeyIndex] = externalAccountBaseId;
            ...
            else
            {
                ...
                // Call the internal method to complete the operation.
                MarkThree.Guardian.Core.AccountBase.Update(adoTransaction, sqlTransaction, ref rowVersion, description, null, null, null, null, null, null, null, null, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, accountBaseId, address0, address1, address2, city, countryId, currencyId, mnemonic, postalCode, provinceId, typeCode, userId, userData0, userData1, userData2, userData3, userData4, userData5, userData6, userData7);
            }
            // Return values.
        ...
        /// <summary>Updates a AccountBase record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public new static void Update(ParameterList parameters)
        {
            ...
            object readOnly = parameters["readOnly"].Value;
            object worldPermission = parameters["worldPermission"].Value;
            string externalAccountBaseId = ((string)(parameters["accountBaseId"]));
            object address0 = parameters["address0"].Value;
            object address1 = parameters["address1"].Value;
            object address2 = parameters["address2"].Value;
            object city = parameters["city"].Value;
            ...
            long rowVersion = long.MinValue;
            // Resolve External Identifiers
            int accountBaseId = Object.FindRequiredKey(configurationId, "accountBaseId", externalAccountBaseId);
            object countryId = Country.FindOptionalKey(configurationId, "countryId", externalCountryId);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.AccountBase.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.AccountBaseLock);
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.ConfigurationLock);
        }
        
        /// <summary>Deletes a AccountBase record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public new static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(accountBaseRow[accountBaseTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.AccountBase.Delete(adoTransaction, sqlTransaction, rowVersion, accountBaseId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.AccountBase.Archive(adoTransaction);
