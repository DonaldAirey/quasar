...
namespace MarkThree.Guardian.External
{
    ...
    public class Country
    {
        ...
        static Country()
        {
            ...
            ServerMarketData.CountryLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            Country.externalKeyArray = new DataView[] {
                    countryTable.KeyCountryExternalId0,
                    countryTable.KeyCountryExternalId1};
            // The table must be released after the array is constructed.
            ServerMarketData.CountryLock.ReleaseReaderLock();
        }
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.Country.Insert(adoTransaction);
            MarkThree.Guardian.Core.Country.Update(adoTransaction);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Country.Delete(adoTransaction);
        ...
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(countryRow[countryTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.Country.Delete(adoTransaction, sqlTransaction, rowVersion, countryId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Country.Archive(adoTransaction);
