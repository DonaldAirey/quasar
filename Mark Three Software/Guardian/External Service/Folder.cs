...
namespace MarkThree.Guardian.External
{
    ...
    public class Folder : Object
    {
        ...
        public new static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.Folder.Insert(adoTransaction);
            MarkThree.Guardian.Core.Folder.Update(adoTransaction);
        ...
        public new static void Load(ParameterList parameters)
        {
            ...
            if ((folderRow == null))
            {
                ...
                MarkThree.Guardian.Core.Folder.Insert(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, externalId2, externalId3, externalId4, externalId5, externalId6, externalId7, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, typeCode);
            }
            else
            {
                ...
                // Call the internal method to complete the operation.
                MarkThree.Guardian.Core.Folder.Update(adoTransaction, sqlTransaction, ref rowVersion, description, null, null, null, null, null, null, null, null, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, folderId, typeCode);
            }
            // Return values.
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Folder.Delete(adoTransaction);
        ...
        public new static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(folderRow[folderTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.Folder.Delete(adoTransaction, sqlTransaction, rowVersion, folderId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.Folder.Archive(adoTransaction);
