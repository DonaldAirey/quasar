...
namespace MarkThree.Guardian.External
{
    ...
    public class LotHandling
    {
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.LotHandling.Insert(adoTransaction);
            MarkThree.Guardian.Core.LotHandling.Update(adoTransaction);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.LotHandling.Delete(adoTransaction);
        ...
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(lotHandlingRow[lotHandlingTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.LotHandling.Delete(adoTransaction, sqlTransaction, rowVersion, lotHandlingCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.LotHandling.Archive(adoTransaction);
