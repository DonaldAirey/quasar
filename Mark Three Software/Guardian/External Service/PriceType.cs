...
namespace MarkThree.Guardian.External
{
    ...
    public class PriceType
    {
        ...
        static PriceType()
        {
            ...
            ServerMarketData.PriceTypeLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            PriceType.externalKeyArray = new DataView[] {
                    priceTypeTable.KeyPriceTypeExternalId0,
                    priceTypeTable.KeyPriceTypeExternalId1,
                    priceTypeTable.KeyPriceTypeExternalId2,
                    priceTypeTable.KeyPriceTypeExternalId3};
            // The table must be released after the array is constructed.
            ServerMarketData.PriceTypeLock.ReleaseReaderLock();
        }
        ...
        /// <summary>Finds a a PriceType record using a configuration and an external identifier.</summary>
        /// <param name="configurationId">Specified which mappings (user id columns) to use when looking up external identifiers.</param>
        /// <param name="parameterId">The name of the parameter as specified in the configuration table.</param>
        ...
        public static int FindKey(object configurationId, string parameterId, object externalId)
        {
            ...
            int externalKeyIndex = PriceType.GetExternalKeyIndex(configurationId, parameterId);
            System.Data.DataView externalKeyView = PriceType.externalKeyArray[externalKeyIndex];
            ...
            return ((int)(externalKeyView[recordIndex].Row[priceTypeTable.PriceTypeCodeColumn]));
        }
        ...
        public static int FindRequiredKey(object configurationId, string parameterId, string externalId)
        {
            ...
            int internalId = PriceType.FindKey(configurationId, parameterId, externalId);
            if ((internalId == int.MinValue))
            {
                throw new Exception(string.Format("The PriceType table does not have a record identified by \'{0}\'", externalId));
            }
        ...
        public static object FindOptionalKey(object configurationId, string parameterId, object externalId)
        {
            ...
            if ((externalId != null))
            {
                internalId = PriceType.FindKey(configurationId, parameterId, ((string)(externalId)));
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.PriceType.Insert(adoTransaction);
            MarkThree.Guardian.Core.PriceType.Update(adoTransaction);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.PriceType.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.PriceTypeLock);
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.ConfigurationLock);
        }
        
        /// <summary>Deletes a PriceType record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(priceTypeRow[priceTypeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.PriceType.Delete(adoTransaction, sqlTransaction, rowVersion, priceTypeCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.PriceType.Archive(adoTransaction);
