...
namespace MarkThree.Guardian.External
{
    ...
    public class StylesheetType
    {
        ...
        static StylesheetType()
        {
            ...
            ServerMarketData.StylesheetTypeLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            StylesheetType.externalKeyArray = new DataView[] {
                    stylesheetTypeTable.KeyStylesheetTypeExternalId0,
                    stylesheetTypeTable.KeyStylesheetTypeExternalId1};
            // The table must be released after the array is constructed.
            ServerMarketData.StylesheetTypeLock.ReleaseReaderLock();
        }
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.StylesheetType.Insert(adoTransaction);
            MarkThree.Guardian.Core.StylesheetType.Update(adoTransaction);
            // These table lock(s) are required for the 'Load' operation.
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.StylesheetTypeLock);
        ...
        public static void Load(ParameterList parameters)
        {
            ...
            if ((stylesheetTypeRow == null))
            {
                ...
                MarkThree.Guardian.Core.StylesheetType.Insert(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, name, stylesheetTypeCode);
            }
            else
            {
                ...
                MarkThree.Guardian.Core.StylesheetType.Update(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, name, stylesheetTypeCode);
            }
            // Return values
        ...
        public static void Update(ParameterList parameters)
        {
            ...
            MarkThree.Guardian.Core.StylesheetType.Update(adoTransaction, sqlTransaction, ref rowVersion, description, null, null, name, stylesheetTypeCode);
            // Return values.
            parameters["rowVersion"] = rowVersion;
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.StylesheetType.Delete(adoTransaction);
        ...
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(stylesheetTypeRow[stylesheetTypeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.StylesheetType.Delete(adoTransaction, sqlTransaction, rowVersion, stylesheetTypeCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.StylesheetType.Archive(adoTransaction);
        ...
        public static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(stylesheetTypeRow[stylesheetTypeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.StylesheetType.Archive(adoTransaction, sqlTransaction, rowVersion, stylesheetTypeCode);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             
