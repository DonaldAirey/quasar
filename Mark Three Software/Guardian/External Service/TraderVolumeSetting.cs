...
namespace MarkThree.Guardian.External
{
    ...
    public class TraderVolumeSetting
    {
        ...
        static TraderVolumeSetting()
        {
            // The table must be locked before the indices can be read into an accelerator array.
            ServerMarketData.TraderVolumeSettingLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            TraderVolumeSetting.externalKeyArray = new DataView[] {
                    traderVolumeSettingTable.KeyTraderVolumeSettingExternalId0};
            // The table must be released after the array is constructed.
            ServerMarketData.TraderVolumeSettingLock.ReleaseReaderLock();
        }
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Guardian.Core.TraderVolumeSetting.Insert(adoTransaction);
            MarkThree.Guardian.Core.TraderVolumeSetting.Update(adoTransaction);
            // These table lock(s) are required for the 'Load' operation.
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.TraderVolumeSettingLock);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.TraderVolumeSetting.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.TraderVolumeSettingLock);
            adoTransaction.LockRequests.AddReaderLock(ServerMarketData.ConfigurationLock);
        }
        
        /// <summary>Deletes a TraderVolumeSetting record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(traderVolumeSettingRow[traderVolumeSettingTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Guardian.Core.TraderVolumeSetting.Delete(adoTransaction, sqlTransaction, rowVersion, traderVolumeSettingId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Guardian.Core.TraderVolumeSetting.Archive(adoTransaction);
