namespace MarkThree
{
	...
	/// <summary>
	/// FIX tag definitions. TagName=TagNumber.
	...
	public enum Tag
	{
		...
		CxlRejReason=102,
		OrdRejReason=103,
		IOIQualifier=104,				// Part of a repeating group - see IoiQualifierGroup below.
		WaveNo=105,
		Issuer=106,
		SecurityDesc=107,
		HeartBtInt=108,
		...
		NoIOIQualifiers=199,		// Part of a repeating group - see IoiQualifierGroup below.
		...
		XmlData=213,
		SettlInstRefID=214,
		NoRoutingIDs=215,		// Part of a repeating group - see RoutingGroup below.
		RoutingType=216,		// Part of a repeating group - see RoutingGroup below.
		RoutingID=217,		// Part of a repeating group - see RoutingGroup below.
		...
		//    Reserved/Allocated_to_the_Fixed_Income_proposal    261,
		MDReqID=262,
		...
		/// <summary>
		/// The tag numbers 5000 to 9999 have been reserved for use with 
		/// user defined fields, which are used as part of inter-firm communcation. 
		...
		///////////////////////////////
		Tag9426=9426,
		// CMS cancel reduce tags are registered with FIX.
		CMSCxlQty=9428,
		CMSLeavesQty=9429,
		///////////////////////////////
		// 9890 - 9899
		...
		Tag9989=9989,
		/// <summary>
		/// The tag numbers greater than or equal to 10000 have been 
		/// reserved for internal use (within a single firm) and do 
		/// not need to be registered/reserved via the FIX website.
		/// </summary>
		InternalSourceId=10001,
		InternalRecordId=10002,
		InternalError=10003,
		// FIX 'repeating groups'. These Tags are used to store objects in the FixMessage. The objects represent a group of repeating data.
		RoutingGroup = 10100,		// a FIX 'repeating group' that includes NoRoutingIDs, RoutingType, and RoutingID.
		IoiQualifierGroup = 10101,	// a FIX 'repeating group' that includes NoIOIQualifiers, and IOIQualifier.
