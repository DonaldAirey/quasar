...
namespace MarkThree.Quasar.Core
{
	...
	public class Order
	{
		...
		/// <summary>Initializes an transaction for an Insert command.</summary>
		/// <param name="parameters">Contains the metadata parameters.</param>
		public static void BeginInsert(ParameterList parameters)
		{
			...
			Order.BeginInsert(adoTransaction, blockOrderId, accountId, securityId, settlementId, brokerId, positionTypeCode, transactionTypeCode, timeInForceCode, orderTypeCode, conditionCode, createdUserId, modifiedUserId);
		}

		/// <summary>Collects the table lock request(s) for an Update operation</summary>
		/// <param name="adoTransaction">A list of locks required for this operation.</param>
		public static void BeginInsert(AdoTransaction adoTransaction, object blockOrderId, object accountId, object securityId, object settlementId, object brokerId, object positionTypeCode, object transactionTypeCode, object timeInForceCode, object orderTypeCode, object conditionCode, object createdUserId, object modifiedUserId)
		{
