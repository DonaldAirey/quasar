namespace MarkThree.Quasar
{
	...
	public class DataModel : DataSetQuasar
	{
		...
		/// </summary>
		protected static int InstanceCount { get { return DataModel.instanceCount; } }
		...
		public static long Merge(ArrayList reconciledData)
		{
			...
			while (reconciledData.Count != 0)
			{
				...
				while (tableIndex < reconciledData.Count)
				{
					...
					Table destinationTable = DataModel.Tables[(string)tableData[tableTableNameIndex]];
