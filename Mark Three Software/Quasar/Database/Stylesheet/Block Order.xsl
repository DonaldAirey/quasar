...
<xsl:stylesheet version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<!-- These parameters are used by the loader to specify the attributes of the stylesheet. -->
 	<mts:stylesheetId>BLOCK ORDER</mts:stylesheetId>
	<mts:stylesheetTypeCode>BLOCK ORDER</mts:stylesheetTypeCode>
	<mts:name>Standard Block Order</mts:name>
	...
	<xsl:template match="Blotter">
			...
			<ss:Workbook xmlns:o="urn:schemas-microsoft-com:office:office"
				...
				<ss:Names>
					...
					<ss:NamedRange ss:Name="lastPrice" ss:RefersTo="=Sheet1!C9"/>
					<ss:NamedRange ss:Name="bidPrice" ss:RefersTo="=Sheet1!C10"/>
					<ss:NamedRange ss:Name="askPrice" ss:RefersTo="=Sheet1!C11"/>
				...
				<ss:Worksheet ss:Name="Sheet1">
					...
					<ss:Table>
						...
						<ss:Column ss:Index="6" ss:Width="50" ss:StyleID="LeftText" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="7" ss:Width="143.25" ss:StyleID="LeftText" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="8" ss:Width="100" ss:StyleID="LeftText" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="9" ss:Width="36.75" ss:StyleID="Price" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="10" ss:Width="49.5" ss:StyleID="Quantity" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="11" ss:Width="49.5" ss:StyleID="Quantity" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="12" ss:Width="49.5" ss:StyleID="Quantity" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="13" ss:Width="29.25" ss:StyleID="Date" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="14" ss:Width="29.25" ss:StyleID="Date" ss:AutoFitWidth="0"/>
						...
						<ss:Column ss:Index="15" ss:Width="143.25" ss:AutoFitWidth="0"/>
	...
	<xsl:template match="BlockOrder">
		...
		<xsl:variable name="SellLeftTextStyle">
			<xsl:choose>
				<xsl:when test="@StatusCode != 3 and (@TransactionTypeCode = 3 or @TransactionTypeCode = 5)">SellLeftText</xsl:when>
		...
		<xsl:variable name="CenterTextStyle">
			<xsl:choose>
				<xsl:when test="@StatusCode = 3">ClosedCenterText</xsl:when>
