...
<xsl:stylesheet version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<xsl:template match="Blotter">
			...
			<ss:Workbook xmlns:o="urn:schemas-microsoft-com:office:office"
				...
				<ss:Names>
					...
					<ss:NamedRange ss:Name="yield" ss:RefersTo="=Sheet1!C10"/>
					<ss:NamedRange ss:Name="lastPrice" ss:RefersTo="=Sheet1!C11"/>
				...
				<ss:Worksheet ss:Name="Sheet1">
					...
					<ss:Table>
						...
						<ss:Column ss:Index="10" ss:Width="36" ss:StyleID="Percent" ss:AutoFitWidth="0"/>
	...
	<xsl:template match="BlockOrder">
		...
		<ss:Row ss:Height="12">
			...
			<ss:Cell ss:Index="10" ss:Formula="=YieldFromPrice(RC8, RC9, RC17, RC11)">
			...
			<ss:Cell ss:Index="12" ss:Formula="=Duration(RC8, RC9, RC17, RC10)">
				<xsl:attribute name="ss:StyleID"><xsl:value-of select="$PriceStyle"/></xsl:attribute>
				<ss:Data ss:Type="Number">0</ss:Data>
			</ss:Cell>
			<ss:Cell ss:Index="13" ss:Formula="=Convexity(RC8, RC9, RC17, RC10)">
				<xsl:attribute name="ss:StyleID"><xsl:value-of select="$PriceStyle"/></xsl:attribute>
				<ss:Data ss:Type="Number">0</ss:Data>
			</ss:Cell>
			<ss:Cell ss:Index="14">
