...
<xsl:stylesheet version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<xsl:template match="Blotter">
			...
			<ss:Workbook xmlns:o="urn:schemas-microsoft-com:office:office"
				...
				<ss:Names>
					...
					<ss:NamedRange ss:Name="quantityOrdered" ss:RefersTo="=Sheet1!C12"/>
					<ss:NamedRange ss:Name="quantityExecuted" ss:RefersTo="=Sheet1!C13"/>
					<ss:NamedRange ss:Name="tradeDate" ss:RefersTo="=Sheet1!C15"/>
					<ss:NamedRange ss:Name="settlementDate" ss:RefersTo="=Sheet1!C16"/>
				...
				<ss:Worksheet ss:Name="Sheet1">
					...
					<ss:Table>
						...
						<ss:Column ss:Index="13" ss:Width="49.5" ss:StyleID="Quantity" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="14" ss:Width="39.75" ss:StyleID="Date" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="15" ss:Width="39.75" ss:StyleID="Date" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="16" ss:Width="41" ss:StyleID="MarketValue" ss:AutoFitWidth="0"/>
						...
						<ss:Column ss:Index="18" ss:Width="90" ss:AutoFitWidth="0"/>
	...
	<xsl:template match="BlockOrder">
		...
		<ss:Row ss:Height="12">
			...
			<ss:Cell ss:Index="11" ss:Formula="=YieldFromPrice(RC8, RC9, RC15, RC10)">
			...
			<ss:Cell ss:Index="16" ss:Formula="=DebtAccruedInterest(RC8, RC9, RC15)*RC12/100">
