...
<xsl:stylesheet version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<!-- These parameters are used by the loader to specify the attributes of the stylesheet. -->
 	<mts:stylesheetId>EQUITY BLOCK ORDER</mts:stylesheetId>
	<mts:stylesheetTypeCode>BLOCK ORDER</mts:stylesheetTypeCode>
	<mts:name>Equity Block Order</mts:name>
	...
	<xsl:template match="Blotter">
			...
			<ss:Workbook xmlns:o="urn:schemas-microsoft-com:office:office"
				...
				<ss:Names>
					...
					<ss:NamedRange ss:Name="statusCode" ss:RefersTo="=Sheet1!C5"/>
					<ss:NamedRange ss:Name="lastPrice" ss:RefersTo="=Sheet1!C8"/>
					<ss:NamedRange ss:Name="bidPrice" ss:RefersTo="=Sheet1!C9"/>
					<ss:NamedRange ss:Name="askPrice" ss:RefersTo="=Sheet1!C10"/>
					<ss:NamedRange ss:Name="quantityOrdered" ss:RefersTo="=Sheet1!C13"/>
					<ss:NamedRange ss:Name="quantityPlaced" ss:RefersTo="=Sheet1!C14"/>
				...
				<ss:Styles>
					<ss:Style ss:ID="Default">
						<ss:Alignment ss:Horizontal="Automatic" ss:Vertical="Center" ss:ReadingOrder="Context"/>
					...
					<ss:Style ss:ID="SellLeftText" ss:Parent="LeftText">
						<ss:Font ss:FontName="Microsoft Sans Serif" ss:Size="8" ss:Color="#FF0000"/>
					</ss:Style>
				...
				<ss:Worksheet ss:Name="Sheet1">
					...
					<ss:Table>
						...
						<ss:Column ss:Index="6" ss:Width="37.5" ss:StyleID="LeftText" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="7" ss:Width="100" ss:StyleID="LeftText" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="8" ss:Width="31.00" ss:StyleID="Price" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="9" ss:Width="31.00" ss:StyleID="Price" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="10" ss:Width="31.00" ss:StyleID="Price" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="11" ss:Width="30" ss:StyleID="CenterText" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="12" ss:Width="31.00" ss:StyleID="Price" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="13" ss:Width="48" ss:StyleID="Quantity" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="14" ss:Width="48" ss:StyleID="Quantity" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="15" ss:Width="48" ss:StyleID="Quantity" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="16" ss:Width="48" ss:StyleID="Quantity" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="17" ss:Width="29.25" ss:StyleID="Date" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="18" ss:Width="29.25" ss:StyleID="Date" ss:AutoFitWidth="0"/>
						...
						<ss:Column ss:Index="19" ss:Width="115.25" ss:AutoFitWidth="0"/>
						...
						<ss:Row ss:Height="12" ss:StyleID="Header">
							...
							<ss:Cell ss:Index="9" ss:StyleID="HeaderRightText">
								<ss:Data ss:Type="String">Bid</ss:Data>
							</ss:Cell>
							<ss:Cell ss:Index="10" ss:StyleID="HeaderRightText">
								<ss:Data ss:Type="String">Ask</ss:Data>
							</ss:Cell>
							<ss:Cell ss:Index="11" ss:StyleID="HeaderCenterText">
						...
						<ss:Row ss:Height="12" ss:StyleID="Header">
							...
							<ss:Cell ss:Index="14" ss:StyleID="HeaderRightText">
								<ss:Data ss:Type="String">Placed</ss:Data>
							</ss:Cell>
							<ss:Cell ss:Index="15" ss:StyleID="HeaderRightText">
	...
	<xsl:template match="BlockOrder">
		...
		<xsl:variable name="SellLeftTextStyle">
			<xsl:choose>
				<xsl:when test="@StatusCode >= 2">ClosedLeftText</xsl:when>
				<xsl:when test="@TransactionTypeCode = 3 or @TransactionTypeCode = 5">SellLeftText</xsl:when>
				<xsl:otherwise>LeftText</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		<xsl:variable name="CenterTextStyle">
			<xsl:choose>
				<xsl:when test="@StatusCode >= 2">ClosedCenterText</xsl:when>
				<xsl:otherwise>CenterText</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		...
		<xsl:variable name="MarketValueStyle">
			<xsl:choose>
				<xsl:when test="@StatusCode >= 2">ClosedMarketValue</xsl:when>
				<xsl:otherwise>MarketValue</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		<xsl:variable name="PercentStyle">
			<xsl:choose>
				<xsl:when test="@StatusCode >= 2">ClosedPercent</xsl:when>
				<xsl:otherwise>Percent</xsl:otherwise>
			</xsl:choose>
		</xsl:variable>
		<xsl:variable name="DateStyle">
			<xsl:choose>
				<xsl:when test="@StatusCode >= 2">ClosedDate</xsl:when>
		...
		<ss:Row ss:Height="12">
			...
			<xsl:if test="@SecurityId">
				<ss:Cell ss:Index="3">
					<ss:Data ss:Type="Number"><xsl:value-of select="@SecurityId"/></ss:Data>
				</ss:Cell>
			</xsl:if>
			<xsl:if test="@TransactionTypeCode">
				<ss:Cell ss:Index="4">
					<xsl:attribute name="ss:StyleID"><xsl:value-of select="$SellLeftTextStyle"/></xsl:attribute>
			...
			<xsl:if test="@SecurityId">
				...
				<ss:Cell ss:Index="8">
					<xsl:attribute name="ss:StyleID">Price</xsl:attribute>
					<ss:Data ss:Type="Number"><xsl:value-of select="@LastPrice"/></ss:Data>
				</ss:Cell>
				<ss:Cell ss:Index="9">
					<xsl:attribute name="ss:StyleID">Price</xsl:attribute>
					<ss:Data ss:Type="Number"><xsl:value-of select="@BidPrice"/></ss:Data>
				</ss:Cell>
				<ss:Cell ss:Index="10">
					<xsl:attribute name="ss:StyleID">Price</xsl:attribute>
					<ss:Data ss:Type="Number"><xsl:value-of select="@AskPrice"/></ss:Data>
				</ss:Cell>
			</xsl:if>
			<xsl:if test="@TimeInForceCode">
				<ss:Cell ss:Index="11">
					<xsl:attribute name="ss:StyleID"><xsl:value-of select="$CenterTextStyle"/></xsl:attribute>
					<ss:Data ss:Type="String"><xsl:value-of select="@TimeInForceName"/></ss:Data>
				</ss:Cell>
			</xsl:if>
			<xsl:if test="@OrderTypeCode">
				<ss:Cell ss:Index="12">
					<xsl:attribute name="ss:StyleID"><xsl:value-of select="$RightTextStyle"/></xsl:attribute>
					<ss:Data ss:Type="String"><xsl:value-of select="@OrderTypeName"/></ss:Data>
				</ss:Cell>
			</xsl:if>
			<ss:Cell ss:Index="13">
				<xsl:attribute name="ss:StyleID"><xsl:value-of select="$QuantityStyle"/></xsl:attribute>
			...
			<ss:Cell ss:Index="14">
				...
				<ss:Data ss:Type="Number"><xsl:value-of select="@QuantityPlaced"/></ss:Data>
			</ss:Cell>
			<ss:Cell ss:Index="15">
				<xsl:attribute name="ss:StyleID"><xsl:value-of select="$EditQuantityStyle"/></xsl:attribute>
				<ss:Data ss:Type="Number"><xsl:value-of select="@QuantityExecuted"/></ss:Data>
			</ss:Cell>
			<ss:Cell ss:Index="16" ss:Formula="=RC13-RC15">
				<xsl:attribute name="ss:StyleID"><xsl:value-of select="$QuantityStyle"/></xsl:attribute>
