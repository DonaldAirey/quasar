...
<xsl:stylesheet version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<!-- These parameters are used by the loader to specify the attributes of the stylesheet. -->
 	<mts:stylesheetId>EQUITY EXECUTION</mts:stylesheetId>
	<mts:stylesheetTypeCode>EXECUTION</mts:stylesheetTypeCode>
	<mts:name>Equity Execution</mts:name>
			...
			<ss:Workbook xmlns:o="urn:schemas-microsoft-com:office:office"
				...
				<ss:Worksheet ss:Name="Sheet1">
					...
					<ss:Table>
						...
						<ss:Column ss:Index="5" ss:Width="40" ss:StyleID="LeftText" ss:AutoFitWidth="0"/>
	...
	<xsl:template match="GlobalExecution">
		...
		<ss:Row ss:Height="12">
			...
			<ss:Cell ss:Index="5">
				<xsl:attribute name="ss:StyleID">BrokerSymbol</xsl:attribute>
				<ss:NamedCell ss:Name="brokerSymbol"/>
			...
			<ss:Cell ss:Index="12">
				<xsl:choose>
					<xsl:when test="../@TransactionTypeCode=3">
						<xsl:attribute name="ss:Formula">=RC6*RC7-RC8-RC9</xsl:attribute>
					</xsl:when>
					<xsl:otherwise>
						<xsl:attribute name="ss:Formula">=RC6*RC7+RC8+RC9</xsl:attribute>
					</xsl:otherwise>
