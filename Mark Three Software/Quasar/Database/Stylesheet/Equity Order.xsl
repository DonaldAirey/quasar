...
<xsl:stylesheet version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<!-- These parameters are used by the loader to specify the attributes of the stylesheet. -->
 	<mts:stylesheetId>EQUITY ORDER</mts:stylesheetId>
	<mts:stylesheetTypeCode>ORDER</mts:stylesheetTypeCode>
	<mts:name>Equity Order</mts:name>
	...
	<xsl:template match="Order">
			...
			<ss:Workbook xmlns:o="urn:schemas-microsoft-com:office:office"
				...
				<ss:Names>
					...
					<ss:NamedRange ss:Name="orderId" ss:RefersTo="=Sheet1!C2"/>
					<ss:NamedRange ss:Name="transactionTypeMnemonic" ss:RefersTo="=Sheet1!C3"/>
					<ss:NamedRange ss:Name="securitySymbol" ss:RefersTo="=Sheet1!C4"/>
					<ss:NamedRange ss:Name="accountMnemonic" ss:RefersTo="=Sheet1!C5"/>
					<ss:NamedRange ss:Name="quantity" ss:RefersTo="=Sheet1!C6"/>
					<ss:NamedRange ss:Name="timeInForceMnemonic" ss:RefersTo="=Sheet1!C7"/>
					<ss:NamedRange ss:Name="orderTypeMnemonic" ss:RefersTo="=Sheet1!C8"/>
					<ss:NamedRange ss:Name="price1" ss:RefersTo="=Sheet1!C9"/>
					<ss:NamedRange ss:Name="price2" ss:RefersTo="=Sheet1!C10"/>
				</ss:Names>
				...
				<ss:Styles>
					...
					<ss:Style ss:ID="SecuritySymbol" ss:Parent="EditLeftText">
					</ss:Style>
				</ss:Styles>
				...
				<ss:Worksheet ss:Name="Sheet1">
					...
					<ss:Table>
						...
						<ss:Column ss:Index="3" ss:Width="35" ss:StyleID="LeftText" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="4" ss:Width="40" ss:StyleID="LeftText" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="5" ss:Width="60" ss:StyleID="LeftText" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="6" ss:Width="49.5" ss:StyleID="Quantity" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="7" ss:Width="31.5" ss:StyleID="CenterText" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="8" ss:Width="31.5" ss:StyleID="CenterText" ss:AutoFitWidth="0"/>
						...
						<ss:Column ss:Index="11" ss:Width="45" ss:StyleID="LeftText" ss:AutoFitWidth="0"/>
						...
						<ss:Column ss:Index="12" ss:Width="49.5" ss:AutoFitWidth="0"/>
						...
						<ss:Row ss:Height="12" ss:StyleID="Header" >
							...
							<ss:Cell ss:Index="7" ss:StyleID="HeaderCenterText">
								<ss:Data ss:Type="String">TIF</ss:Data>
							</ss:Cell>
							<ss:Cell ss:Index="8" ss:StyleID="HeaderCenterText">
	...
	<!-- Order -->
	<xsl:template match="GlobalOrder">

		<!-- Block Heading -->
		<ss:Row ss:Height="12">
			
			<ss:Cell ss:Index="1"><ss:Data ss:Type="Number">1</ss:Data></ss:Cell>
			<ss:Cell ss:Index="2"><ss:Data ss:Type="Number"><xsl:value-of select="@OrderId"/></ss:Data></ss:Cell>
			<ss:Cell ss:Index="4">
	...
	<xsl:template match="LocalOrder">
		...
		<ss:Row ss:Height="12">
			...
			<ss:Cell ss:Index="3">
				<xsl:attribute name="ss:StyleID">EditCenterText</xsl:attribute>
				<xsl:if test="@TransactionTypeMnemonic">
					<ss:Data ss:Type="String"><xsl:value-of select="@TransactionTypeMnemonic"/></ss:Data>
				</xsl:if>
			</ss:Cell>
			<ss:Cell ss:Index="4">
				<xsl:attribute name="ss:StyleID">EditLeftText</xsl:attribute>
				<xsl:if test="@SecuritySymbol">
					<ss:Data ss:Type="String"><xsl:value-of select="@SecuritySymbol"/></ss:Data>
				</xsl:if>
			</ss:Cell>
			<ss:Cell ss:Index="5">
				<xsl:attribute name="ss:StyleID">EditLeftText</xsl:attribute>
				<xsl:if test="@AccountMnemonic">
					<ss:Data ss:Type="String"><xsl:value-of select="@AccountMnemonic"/></ss:Data>
				</xsl:if>
			</ss:Cell>
			<ss:Cell ss:Index="6">
				<xsl:attribute name="ss:StyleID">EditQuantity</xsl:attribute>
			...
			<ss:Cell ss:Index="9">
				<xsl:attribute name="ss:StyleID">EditRightText</xsl:attribute>
				<xsl:if test="@Price1">
					<ss:Data ss:Type="Number"><xsl:value-of select="@Price1"/></ss:Data>
				</xsl:if>
			</ss:Cell>
	...
	<xsl:template match="Placeholder">
		...
		<ss:Row ss:Height="12" >
			...
			<ss:Cell ss:Index="3" ss:StyleID="GrayEditLeftText" >
				<ss:Data ss:Type="String">Click here to add a new Order</ss:Data>
			</ss:Cell>
