...
<xsl:stylesheet version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<!-- Parameters -->
	<xsl:param name="sectorTargetFlag" select="0"/>
			...
			<ss:Workbook xmlns:o="urn:schemas-microsoft-com:office:office"
				...
				<ss:Styles>
					<ss:Style ss:ID="Default">
						...
						<ss:Font ss:FontName="Comic Sans MS" ss:Size="10" x:Family="Script" ss:Color="#FFFFFF"/>
						<ss:Interior ss:Color="#000080" ss:Pattern="Solid"/>
					...
					<ss:Style ss:ID="Header" ss:Parent="Default">
						<ss:Interior ss:Color="#333300" ss:Pattern="Solid"/>
					</ss:Style>
					...
					<Style ss:ID="ShortPosition" ss:Parent="Default">
						<ss:Font ss:FontName="Comic Sans MS" x:Family="Script" ss:Color="#FF0000"/>
					</Style>
					<ss:Style ss:ID="Price" ss:Parent="Default">
						<ss:NumberFormat ss:Format="#,##0.00"/>
					</ss:Style>
					<ss:Style ss:ID="Percent" ss:Parent="Default">
						<ss:NumberFormat ss:Format="0.0%"/>
					</ss:Style>
					<ss:Style ss:ID="EditPercent" ss:Parent="Default">
						<ss:NumberFormat ss:Format="0.0%"/>
						<ss:Protection ss:Protected="0"/>
						<ss:Interior ss:Color="#666699" ss:Pattern="Solid"/>
					</ss:Style>
					<ss:Style ss:ID="Quantity" ss:Parent="Default">
						<ss:NumberFormat ss:Format="#,##0_);[Red]\(#,##0\)"/>
					</ss:Style>
					<ss:Style ss:ID="EditQuantity" ss:Parent="Default">
						<ss:NumberFormat ss:Format="#,##0_);[Red]\(#,##0\)"/>
						<ss:Protection ss:Protected="0"/>
						<ss:Interior ss:Color="#666699" ss:Pattern="Solid"/>
					</ss:Style>
					<ss:Style ss:ID="MarketValue" ss:Parent="Default">
						<ss:NumberFormat ss:Format="#,##0"/>
					</ss:Style>
					<ss:Style ss:ID="BoldMarketValue" ss:Parent="Default">
						<ss:Font ss:FontName="Comic Sans MS" x:Family="Script" ss:Bold="1" ss:Color="#FFFFFF"/>
						<ss:NumberFormat ss:Format="#,##0"/>
					</ss:Style>
					<ss:Style ss:ID="Sector" ss:Parent="Default">
						<ss:Alignment ss:Vertical="Center"/>
						<ss:Font ss:FontName="Comic Sans MS" ss:Size="12" x:Family="Script" ss:Color="#FFFFFF"/>
					</ss:Style>
					<ss:Style ss:ID="Subtotal" ss:Parent="Default">
						<ss:Font ss:FontName="Comic Sans MS" x:Family="Script" ss:Bold="1" ss:Color="#FFFFFF"/>
					</ss:Style>
				</ss:Styles>
				...
				<ss:Worksheet ss:Name="Sheet1">
					...
					<ss:Table>
						...
						<ss:Column ss:Index="5" ss:Width="35" ss:AutoFitWidth="0" ss:StyleID="Percent"/>
						<ss:Column ss:Index="6" ss:Width="35" ss:AutoFitWidth="0" ss:StyleID="Percent"/>
						...
						<ss:Column ss:Index="16" ss:Width="54" ss:AutoFitWidth="0" ss:StyleID="Quantity"/>
						<ss:Column ss:Index="17" ss:Width="54" ss:AutoFitWidth="0" ss:StyleID="Quantity"/>
						<ss:Column ss:Index="18" ss:Width="54" ss:AutoFitWidth="0" ss:StyleID="Quantity"/>
						<ss:Column ss:Index="19" ss:Width="54" ss:AutoFitWidth="0" ss:StyleID="Quantity"/>
						...
						<ss:Column ss:Index="22" ss:Width="180" ss:AutoFitWidth="0"/>
	...
	<xsl:template match="Sector">
		...
		<ss:Row ss:Height="17.25">
			...
			<xsl:if test="$sectorTargetFlag = 1 and number($depth)=1">
				<ss:Cell ss:Index="5">
