...
<xsl:stylesheet version="1.0" xmlns="urn:schemas-microsoft-com:office:spreadsheet"
	...
	<!-- These parameters are used by the loader to specify the attributes of the stylesheet. -->
 	<mts:stylesheetId>TICKET</mts:stylesheetId>
	<mts:stylesheetTypeCode>TICKET</mts:stylesheetTypeCode>
	<mts:name>Standard Ticket</mts:name>
	...
	<xsl:template match="Tickets">
			...
			<ss:Workbook xmlns:o="urn:schemas-microsoft-com:office:office"
				...
				<ss:Names>
					...
					<ss:NamedRange ss:Name="commission" ss:RefersTo="=Sheet1!C8"/>
					<ss:NamedRange ss:Name="userFee0" ss:RefersTo="=Sheet1!C9"/>
					<ss:NamedRange ss:Name="tradeDate" ss:RefersTo="=Sheet1!C10"/>
					<ss:NamedRange ss:Name="settlementDate" ss:RefersTo="=Sheet1!C11"/>
					<ss:NamedRange ss:Name="createdDate" ss:RefersTo="=Sheet1!C12"/>
					<ss:NamedRange ss:Name="createdTime" ss:RefersTo="=Sheet1!C13"/>
					<ss:NamedRange ss:Name="modifiedDate" ss:RefersTo="=Sheet1!C14"/>
					<ss:NamedRange ss:Name="modifiedTime" ss:RefersTo="=Sheet1!C15"/>
				</ss:Names>
				...
				<ss:Worksheet ss:Name="Sheet1">
					...
					<ss:Table>
						...
						<ss:Column ss:Index="10" ss:Width="28" ss:StyleID="ShortDate" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="11" ss:Width="28" ss:StyleID="ShortDate" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="12" ss:Width="45" ss:StyleID="MarketValue" ss:AutoFitWidth="0"/>
						<ss:Column ss:Index="13" ss:Width="45" ss:StyleID="ShortDateTime" ss:AutoFitWidth="0"/>
						...
						<ss:Column ss:Index="14" ss:Width="49.5" ss:AutoFitWidth="0"/>
	...
	<xsl:template match="Ticket">
		...
		<ss:Row ss:Height="12">
			...
			<ss:Cell ss:Index="12" ss:Formula="=RC6*RC7+RC8+RC9">
