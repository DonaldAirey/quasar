...
*
*	File:			ModelType.sql
*	Description:	Categories for Models
...
execute "ObjectProlog" "ModelType"
go

/* Revision 1 */

if ("dbo"."RevisionNeeded" ('ModelType', 1) = 1)
begin
	...
	execute "RemoveObject" "ModelType"
	...
	execute ('
		ALTER TABLE "ModelType" WITH NOCHECK ADD 
			CONSTRAINT "PKModelType" PRIMARY KEY  CLUSTERED 
			(
				"ModelTypeCode"
			)  ON "PRIMARY" 
	')
	...
	execute ('
		ALTER TABLE "ModelType" WITH NOCHECK ADD 
			CONSTRAINT "DefaultModelTypeIsArchived" DEFAULT (0) FOR "IsArchived",
			CONSTRAINT "DefaultModelTypeIsDeleted" DEFAULT (0) FOR "IsDeleted"
	')
...
execute "ObjectEpilog" "ModelType"
go
