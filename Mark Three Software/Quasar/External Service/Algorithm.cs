...
namespace MarkThree.Quasar.External
{
    ...
    public class Algorithm
    {
        ...
        public static int FindRequiredKey(object configurationId, string parameterId, string externalId)
        {
            ...
            int internalId = Algorithm.FindKey(configurationId, parameterId, externalId);
        ...
        public static object FindOptionalKey(object configurationId, string parameterId, object externalId)
        {
            ...
            if ((externalId != null))
            {
                internalId = Algorithm.FindKey(configurationId, parameterId, ((string)(externalId)));
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.Algorithm.Insert(adoTransaction);
            MarkThree.Quasar.Core.Algorithm.Update(adoTransaction);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Algorithm.Delete(adoTransaction);
        ...
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(algorithmRow[algorithmTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Algorithm.Delete(adoTransaction, sqlTransaction, rowVersion, algorithmId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Algorithm.Archive(adoTransaction);
