...
namespace MarkThree.Quasar.External
{
    ...
    public class BlotterMap
    {
        ...
        static BlotterMap()
        {
            ...
            ServerDataModel.BlotterMapLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            BlotterMap.externalKeyArray = new DataView[] {
                    blotterMapTable.UKBlotterMapExternalId0,
                    blotterMapTable.UKBlotterMapExternalId1};
            // The table must be released after the array is constructed.
            ServerDataModel.BlotterMapLock.ReleaseReaderLock();
        }
        ...
        /// <summary>Finds a a BlotterMap record using a configuration and an external identifier.</summary>
        /// <param name="configurationId">Specified which mappings (user id columns) to use when looking up external identifiers.</param>
        /// <param name="parameterId">The name of the parameter as specified in the configuration table.</param>
        ...
        public static int FindKey(object configurationId, string parameterId, object externalId)
        {
            ...
            int externalKeyIndex = BlotterMap.GetExternalKeyIndex(configurationId, parameterId);
            System.Data.DataView externalKeyView = BlotterMap.externalKeyArray[externalKeyIndex];
            ...
            return ((int)(externalKeyView[recordIndex].Row[blotterMapTable.BlotterMapIdColumn]));
        }
        ...
        public static int FindRequiredKey(object configurationId, string parameterId, string externalId)
        {
            ...
            int internalId = BlotterMap.FindKey(configurationId, parameterId, externalId);
            if ((internalId == int.MinValue))
            {
                throw new Exception(string.Format("The BlotterMap table does not have a record identified by \'{0}\'", externalId));
            }
        ...
        public static object FindOptionalKey(object configurationId, string parameterId, object externalId)
        {
            ...
            if ((externalId != null))
            {
                internalId = BlotterMap.FindKey(configurationId, parameterId, ((string)(externalId)));
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.BlotterMap.Insert(adoTransaction);
            MarkThree.Quasar.Core.BlotterMap.Update(adoTransaction);
            // These table lock(s) are required for the 'Load' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.BlotterMap));
        ...
        /// <summary>Loads a BlotterMap record using Metadata Parameters.</summary>
        ...
        public static void Load(ParameterList parameters)
        {
            ...
            object externalBlotterMapId = parameters["blotterMapId"].Value;
            ...
            int blotterMapId = BlotterMap.FindKey(configurationId, "blotterMapId", externalBlotterMapId);
            ...
            if ((blotterMapId == int.MinValue))
            {
                // Populate the 'externalId' varaibles so that the external identifier can be used to find the row when an
                // external method is called with the same 'configurationId' parameter.
                int externalKeyIndex = BlotterMap.GetExternalKeyIndex(configurationId, "blotterMapId");
                object[] externalIdArray = new object[2];
                externalIdArray[externalKeyIndex] = externalBlotterMapId;
                externalId0 = externalIdArray[0];
                externalId1 = externalIdArray[1];
                // Call the internal method to complete the operation.
                MarkThree.Quasar.Core.BlotterMap.Insert(adoTransaction, sqlTransaction, ref rowVersion, securityId, blotterId, minimumQuantity, maximumQuantity, externalId0, externalId1);
            }
            else
            {
                ...
                // Call the internal method to complete the operation.
                MarkThree.Quasar.Core.BlotterMap.Update(adoTransaction, sqlTransaction, ref rowVersion, blotterMapId, securityId, blotterId, minimumQuantity, maximumQuantity, externalId0, externalId1);
            }
            // Return values.
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.BlotterMap.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.BlotterMap));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Deletes a BlotterMap record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(blotterMapRow[blotterMapTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.BlotterMap.Delete(adoTransaction, sqlTransaction, rowVersion, blotterMapId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.BlotterMap.Archive(adoTransaction);
