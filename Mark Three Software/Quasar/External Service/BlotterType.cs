...
namespace MarkThree.Quasar.External
{
    ...
    public class BlotterType
    {
        ...
        static BlotterType()
        {
            ...
            ServerDataModel.BlotterTypeLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            BlotterType.externalKeyArray = new DataView[] {
                    blotterTypeTable.UKBlotterTypeExternalId0,
                    blotterTypeTable.UKBlotterTypeExternalId1};
            // The table must be released after the array is constructed.
            ServerDataModel.BlotterTypeLock.ReleaseReaderLock();
        }
        ...
        /// <summary>Finds a a BlotterType record using a configuration and an external identifier.</summary>
        /// <param name="configurationId">Specified which mappings (user id columns) to use when looking up external identifiers.</param>
        /// <param name="parameterId">The name of the parameter as specified in the configuration table.</param>
        ...
        public static int FindKey(object configurationId, string parameterId, object externalId)
        {
            ...
            int externalKeyIndex = BlotterType.GetExternalKeyIndex(configurationId, parameterId);
            System.Data.DataView externalKeyView = BlotterType.externalKeyArray[externalKeyIndex];
            ...
            return ((int)(externalKeyView[recordIndex].Row[blotterTypeTable.BlotterTypeCodeColumn]));
        }
        ...
        public static int FindRequiredKey(object configurationId, string parameterId, string externalId)
        {
            ...
            int internalId = BlotterType.FindKey(configurationId, parameterId, externalId);
            if ((internalId == int.MinValue))
            {
                throw new Exception(string.Format("The BlotterType table does not have a record identified by \'{0}\'", externalId));
            }
        ...
        public static object FindOptionalKey(object configurationId, string parameterId, object externalId)
        {
            ...
            if ((externalId != null))
            {
                internalId = BlotterType.FindKey(configurationId, parameterId, ((string)(externalId)));
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.BlotterType.Insert(adoTransaction);
            MarkThree.Quasar.Core.BlotterType.Update(adoTransaction);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.BlotterType.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.BlotterType));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Deletes a BlotterType record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(blotterTypeRow[blotterTypeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.BlotterType.Delete(adoTransaction, sqlTransaction, rowVersion, blotterTypeCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.BlotterType.Archive(adoTransaction);
