...
namespace MarkThree.Quasar.External
{
    ...
    public class Broker : Object
    {
        ...
        public new static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.Broker.Insert(adoTransaction);
            MarkThree.Quasar.Core.Broker.Update(adoTransaction);
            // These table lock(s) are required for the 'Load' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Broker));
        ...
        public new static void Load(ParameterList parameters)
        {
            ...
            int brokerId = Object.FindKey(configurationId, "brokerId", externalBrokerId);
            ...
            if ((brokerRow == null))
            {
                ...
                MarkThree.Quasar.Core.Broker.Insert(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, externalId2, externalId3, externalId4, externalId5, externalId6, externalId7, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, typeCode, connected, symbol, phone);
            }
            else
            {
                ...
                // Call the internal method to complete the operation.
                MarkThree.Quasar.Core.Broker.Update(adoTransaction, sqlTransaction, ref rowVersion, description, null, null, null, null, null, null, null, null, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, brokerId, typeCode, connected, symbol, phone);
            }
            // Return values.
        ...
        public new static void Update(ParameterList parameters)
        {
            ...
            long rowVersion = long.MinValue;
            // Resolve External Identifiers
            int brokerId = Object.FindRequiredKey(configurationId, "brokerId", externalBrokerId);
            object typeCode = Type.FindOptionalKey(configurationId, "typeCode", externalTypeCode);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Broker.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Broker));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Deletes a Broker record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public new static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(brokerRow[brokerTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Broker.Delete(adoTransaction, sqlTransaction, rowVersion, brokerId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Broker.Archive(adoTransaction);
        ...
        public new static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(brokerRow[brokerTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Broker.Archive(adoTransaction, sqlTransaction, rowVersion, brokerId);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   // Every exception from the SQL server call is packed into the 'RemoteMethod' structure and returned to the caller.
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            Shadows.WebService.Core.Broker.Archive(transaction);
            // These table lock(s) are required for the 'Archive' operation.
            transaction.Locks.AddReaderLock(ServerDataModel.BrokerLock);
        ...
        public new static void Archive(Transaction transaction, RemoteMethod remoteMethod)
        {
            try
            {
                ...
                string externalBrokerId = remoteMethod.Parameters.GetRequiredString("brokerId");
                ...
                if ((remoteMethod.HasExceptions == false))
                {
                    ...
                    rowVersion = ((long)(brokerRow[brokerTable.RowVersionColumn]));
                    // Call the internal method to complete the operation.
                    Shadows.WebService.Core.Broker.Archive(transaction, brokerId, rowVersion);
                }
            }
