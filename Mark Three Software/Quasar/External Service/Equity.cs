...
namespace MarkThree.Quasar.External
{
    ...
    public class Equity : Security
    {
        ...
        public new static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.Equity.Insert(adoTransaction);
            MarkThree.Quasar.Core.Equity.Update(adoTransaction);
            // These table lock(s) are required for the 'Load' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Equity));
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Equity.Delete(adoTransaction);
        ...
        public new static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(equityRow[equityTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Equity.Delete(adoTransaction, sqlTransaction, rowVersion, equityId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Equity.Archive(adoTransaction);
