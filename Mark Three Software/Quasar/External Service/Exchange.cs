...
namespace MarkThree.Quasar.External
{
    ...
    public class Exchange
    {
        ...
        static Exchange()
        {
            ...
            ServerDataModel.ExchangeLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            Exchange.externalKeyArray = new DataView[] {
                    exchangeTable.UKExchangeExternalId0,
                    exchangeTable.UKExchangeExternalId1,
                    exchangeTable.UKExchangeExternalId2,
                    exchangeTable.UKExchangeExternalId3};
            // The table must be released after the array is constructed.
            ServerDataModel.ExchangeLock.ReleaseReaderLock();
        }
        ...
        /// <summary>Finds a a Exchange record using a configuration and an external identifier.</summary>
        /// <param name="configurationId">Specified which mappings (user id columns) to use when looking up external identifiers.</param>
        /// <param name="parameterId">The name of the parameter as specified in the configuration table.</param>
        ...
        public static int FindKey(object configurationId, string parameterId, object externalId)
        {
            ...
            int externalKeyIndex = Exchange.GetExternalKeyIndex(configurationId, parameterId);
            System.Data.DataView externalKeyView = Exchange.externalKeyArray[externalKeyIndex];
            ...
            return ((int)(externalKeyView[recordIndex].Row[exchangeTable.ExchangeIdColumn]));
        }
        ...
        public static int FindRequiredKey(object configurationId, string parameterId, string externalId)
        {
            ...
            int internalId = Exchange.FindKey(configurationId, parameterId, externalId);
            if ((internalId == int.MinValue))
            {
                throw new Exception(string.Format("The Exchange table does not have a record identified by \'{0}\'", externalId));
            }
        ...
        public static object FindOptionalKey(object configurationId, string parameterId, object externalId)
        {
            ...
            if ((externalId != null))
            {
                internalId = Exchange.FindKey(configurationId, parameterId, ((string)(externalId)));
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.Exchange.Insert(adoTransaction);
            MarkThree.Quasar.Core.Exchange.Update(adoTransaction);
            // These table lock(s) are required for the 'Load' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Exchange));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Loads a Exchange record using Metadata Parameters.</summary>
        ...
        public static void Load(ParameterList parameters)
        {
            ...
            int exchangeId = Exchange.FindKey(configurationId, "exchangeId", externalExchangeId);
            ...
            if ((exchangeId == int.MinValue))
            {
                ...
                int externalKeyIndex = Exchange.GetExternalKeyIndex(configurationId, "exchangeId");
                object[] externalIdArray = new object[4];
                externalIdArray[externalKeyIndex] = externalExchangeId;
                ...
                MarkThree.Quasar.Core.Exchange.Insert(adoTransaction, sqlTransaction, ref rowVersion, name, externalId0, externalId1, externalId2, externalId3);
            }
            else
            {
                ...
                rowVersion = ((long)(exchangeRow[exchangeTable.RowVersionColumn]));
                // Call the internal method to complete the operation.
                MarkThree.Quasar.Core.Exchange.Update(adoTransaction, sqlTransaction, ref rowVersion, exchangeId, name, externalId0, externalId1, externalId2, externalId3);
            }
            // Return values.
        ...
        /// <summary>Updates a Exchange record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Update(ParameterList parameters)
        {
            ...
            SqlTransaction sqlTransaction = parameters["sqlTransaction"];
            object configurationId = parameters["configurationId"].Value;
            string externalExchangeId = ((string)(parameters["exchangeId"]));
            object name = parameters["name"].Value;
            // The row versioning is largely disabled for external operations.
            long rowVersion = long.MinValue;
            // Resolve External Identifiers
            int exchangeId = Exchange.FindRequiredKey(configurationId, "exchangeId", externalExchangeId);
            // While the optimistic concurrency checking is disabled for the external methods, the internal methods
            // still need to perform the check.  This ncurrency checking logic by finding the current row version to be
            // will bypass the coused when the internal method is called.
            ServerDataModel.ExchangeRow exchangeRow = exchangeTable.FindByExchangeId(exchangeId);
            rowVersion = ((long)(exchangeRow[exchangeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Exchange.Update(adoTransaction, sqlTransaction, ref rowVersion, exchangeId, name, null, null, null, null);
            // Return values.
            parameters["rowVersion"] = rowVersion;
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Exchange.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Exchange));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Deletes a Exchange record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Delete(ParameterList parameters)
        {
            ...
            SqlTransaction sqlTransaction = parameters["sqlTransaction"];
            object configurationId = parameters["configurationId"].Value;
            string externalExchangeId = parameters["exchangeId"];
            // The row versioning is largely disabled for external operations.
            long rowVersion = long.MinValue;
            ...
            rowVersion = ((long)(exchangeRow[exchangeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Exchange.Delete(adoTransaction, sqlTransaction, rowVersion, exchangeId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Exchange.Archive(adoTransaction);
            // These table lock(s) are required for the 'Archive' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Exchange));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Archives a Exchange record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(exchangeRow[exchangeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Exchange.Archive(adoTransaction, sqlTransaction, rowVersion, exchangeId);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       