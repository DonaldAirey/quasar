...
namespace MarkThree.Quasar.External
{
    ...
    public class Folder : Object
    {
        ...
        public new static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.Folder.Insert(adoTransaction);
            MarkThree.Quasar.Core.Folder.Update(adoTransaction);
        ...
        /// <summary>Loads a Folder record using Metadata Parameters.</summary>
        ...
        public new static void Load(ParameterList parameters)
        {
            ...
            int folderId = Object.FindKey(configurationId, "folderId", externalFolderId);
            ...
            if ((folderRow == null))
            {
                ...
                int externalKeyIndex = Folder.GetExternalKeyIndex(configurationId, "folderId");
                object[] externalIdArray = new object[8];
                externalIdArray[externalKeyIndex] = externalFolderId;
                ...
                MarkThree.Quasar.Core.Folder.Insert(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, externalId2, externalId3, externalId4, externalId5, externalId6, externalId7, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, typeCode);
            }
            else
            {
                ...
                // Call the internal method to complete the operation.
                MarkThree.Quasar.Core.Folder.Update(adoTransaction, sqlTransaction, ref rowVersion, description, null, null, null, null, null, null, null, null, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, folderId, typeCode);
            }
            // Return values.
        ...
        /// <summary>Updates a Folder record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public new static void Update(ParameterList parameters)
        {
            ...
            object readOnly = parameters["readOnly"].Value;
            object worldPermission = parameters["worldPermission"].Value;
            string externalFolderId = ((string)(parameters["folderId"]));
            object externalTypeCode = parameters["typeCode"].Value;
            // The row versioning is largely disabled for external operations.  The value is returned to the caller in the
            // event it's needed for operations within the batch.
            long rowVersion = long.MinValue;
            // Resolve External Identifiers
            int folderId = Object.FindRequiredKey(configurationId, "folderId", externalFolderId);
            object typeCode = Type.FindOptionalKey(configurationId, "typeCode", externalTypeCode);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Folder.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Folder));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Deletes a Folder record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public new static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(folderRow[folderTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Folder.Delete(adoTransaction, sqlTransaction, rowVersion, folderId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Folder.Archive(adoTransaction);
        ...
        public new static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(folderRow[folderTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Folder.Archive(adoTransaction, sqlTransaction, rowVersion, folderId);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           (folderRow[folderTable.RowVersionColumn]));
                    // Call the internal method to complete the operation.
                    Shadows.WebService.Core.Folder.Delete(transaction, folderId, rowVersion);
                }
            }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            Shadows.WebService.Core.Folder.Archive(transaction);
            // These table lock(s) are required for the 'Archive' operation.
            transaction.Locks.AddReaderLock(ServerDataModel.FolderLock);
        ...
        public new static void Archive(Transaction transaction, RemoteMethod remoteMethod)
        {
            try
            {
                ...
                string externalFolderId = remoteMethod.Parameters.GetRequiredString("folderId");
                ...
                if ((remoteMethod.HasExceptions == false))
                {
                    ...
                    rowVersion = ((long)(folderRow[folderTable.RowVersionColumn]));
                    // Call the internal method to complete the operation.
                    Shadows.WebService.Core.Folder.Archive(transaction, folderId, rowVersion);
                }
            }
            catch (SqlException sqlException)
            {
