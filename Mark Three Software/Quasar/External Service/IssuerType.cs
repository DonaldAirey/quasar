...
namespace MarkThree.Quasar.External
{
    ...
    public class IssuerType
    {
        ...
        static IssuerType()
        {
            ...
            ServerDataModel.IssuerTypeLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            IssuerType.externalKeyArray = new DataView[] {
                    issuerTypeTable.UKIssuerTypeExternalId0,
                    issuerTypeTable.UKIssuerTypeExternalId1,
                    issuerTypeTable.UKIssuerTypeExternalId2,
                    issuerTypeTable.UKIssuerTypeExternalId3};
            // The table must be released after the array is constructed.
            ServerDataModel.IssuerTypeLock.ReleaseReaderLock();
        }
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.IssuerType.Insert(adoTransaction);
            MarkThree.Quasar.Core.IssuerType.Update(adoTransaction);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.IssuerType.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.IssuerType));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Deletes a IssuerType record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(issuerTypeRow[issuerTypeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.IssuerType.Delete(adoTransaction, sqlTransaction, rowVersion, issuerTypeCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.IssuerType.Archive(adoTransaction);
