...
namespace MarkThree.Quasar.External
{
    ...
    public class LotHandling
    {
        ...
        static LotHandling()
        {
            ...
            ServerDataModel.LotHandlingLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            LotHandling.externalKeyArray = new DataView[] {
                    lotHandlingTable.UKLotHandlingExternalId0,
                    lotHandlingTable.UKLotHandlingExternalId1,
                    lotHandlingTable.UKLotHandlingExternalId2,
                    lotHandlingTable.UKLotHandlingExternalId3};
            // The table must be released after the array is constructed.
            ServerDataModel.LotHandlingLock.ReleaseReaderLock();
        }
        ...
        public static int FindRequiredKey(object configurationId, string parameterId, string externalId)
        {
            ...
            int internalId = LotHandling.FindKey(configurationId, parameterId, externalId);
            if ((internalId == int.MinValue))
            {
                throw new Exception(string.Format("The LotHandling table does not have a record identified by \'{0}\'", externalId));
            }
        ...
        public static object FindOptionalKey(object configurationId, string parameterId, object externalId)
        {
            ...
            if ((externalId != null))
            {
                internalId = LotHandling.FindKey(configurationId, parameterId, ((string)(externalId)));
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.LotHandling.Insert(adoTransaction);
            MarkThree.Quasar.Core.LotHandling.Update(adoTransaction);
        ...
        public static void Load(ParameterList parameters)
        {
            ...
            if ((lotHandlingRow == null))
            {
                ...
                MarkThree.Quasar.Core.LotHandling.Insert(adoTransaction, sqlTransaction, ref rowVersion, lotHandlingCode, mnemonic, description, externalId0, externalId1, externalId2, externalId3);
            }
            else
            {
                ...
                MarkThree.Quasar.Core.LotHandling.Update(adoTransaction, sqlTransaction, ref rowVersion, lotHandlingCode, mnemonic, description, externalId0, externalId1, externalId2, externalId3);
            }
            // Return values
        ...
        public static void Update(ParameterList parameters)
        {
            ...
            MarkThree.Quasar.Core.LotHandling.Update(adoTransaction, sqlTransaction, ref rowVersion, lotHandlingCode, mnemonic, description, null, null, null, null);
            // Return values.
            parameters["rowVersion"] = rowVersion;
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.LotHandling.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.LotHandling));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Deletes a LotHandling record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(lotHandlingRow[lotHandlingTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.LotHandling.Delete(adoTransaction, sqlTransaction, rowVersion, lotHandlingCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.LotHandling.Archive(adoTransaction);
        ...
        public static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(lotHandlingRow[lotHandlingTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.LotHandling.Archive(adoTransaction, sqlTransaction, rowVersion, lotHandlingCode);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             