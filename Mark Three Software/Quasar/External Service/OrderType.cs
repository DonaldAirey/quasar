...
namespace MarkThree.Quasar.External
{
    ...
    public class OrderType
    {
        ...
        static OrderType()
        {
            ...
            ServerDataModel.OrderTypeLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            OrderType.externalKeyArray = new DataView[] {
                    orderTypeTable.UKOrderTypeExternalId0,
                    orderTypeTable.UKOrderTypeExternalId1,
                    orderTypeTable.UKOrderTypeExternalId2,
                    orderTypeTable.UKOrderTypeExternalId3};
            // The table must be released after the array is constructed.
            ServerDataModel.OrderTypeLock.ReleaseReaderLock();
        }
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.OrderType.Insert(adoTransaction);
            MarkThree.Quasar.Core.OrderType.Update(adoTransaction);
            // These table lock(s) are required for the 'Load' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.OrderType));
        ...
        public static void Load(ParameterList parameters)
        {
            ...
            if ((orderTypeRow == null))
            {
                ...
                MarkThree.Quasar.Core.OrderType.Insert(adoTransaction, sqlTransaction, ref rowVersion, orderTypeCode, mnemonic, description, externalId0, externalId1, externalId2, externalId3);
            }
            else
            {
                ...
                MarkThree.Quasar.Core.OrderType.Update(adoTransaction, sqlTransaction, ref rowVersion, orderTypeCode, mnemonic, description, externalId0, externalId1, externalId2, externalId3);
            }
            // Return values
        ...
        public static void Update(ParameterList parameters)
        {
            ...
            MarkThree.Quasar.Core.OrderType.Update(adoTransaction, sqlTransaction, ref rowVersion, orderTypeCode, mnemonic, description, null, null, null, null);
            // Return values.
            parameters["rowVersion"] = rowVersion;
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.OrderType.Delete(adoTransaction);
        ...
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(orderTypeRow[orderTypeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.OrderType.Delete(adoTransaction, sqlTransaction, rowVersion, orderTypeCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.OrderType.Archive(adoTransaction);
        ...
        public static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(orderTypeRow[orderTypeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.OrderType.Archive(adoTransaction, sqlTransaction, rowVersion, orderTypeCode);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               