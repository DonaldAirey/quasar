...
namespace MarkThree.Quasar.External
{
    ...
    public class PositionTarget
    {
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.PositionTarget.Insert(adoTransaction);
            MarkThree.Quasar.Core.PositionTarget.Update(adoTransaction);
            // These table lock(s) are required for the 'Load' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.PositionTarget));
        ...
        /// <summary>Loads a PositionTarget record using Metadata Parameters.</summary>
        ...
        public static void Load(ParameterList parameters)
        {
            ...
            if ((positionTargetRow == null))
            {
                ...
                MarkThree.Quasar.Core.PositionTarget.Insert(adoTransaction, sqlTransaction, ref rowVersion, modelId, securityId, positionTypeCode, percent);
            }
            else
            {
                // This will bypass the optimistic concurrency checking required by the internal method.
                rowVersion = ((long)(positionTargetRow[positionTargetTable.RowVersionColumn]));
                // Call the internal 'Update' method to complete the operation.
                MarkThree.Quasar.Core.PositionTarget.Update(adoTransaction, sqlTransaction, ref rowVersion, modelId, securityId, positionTypeCode, percent);
            }
            // Return values
        ...
        /// <summary>Updates a PositionTarget record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.PositionTarget.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.PositionTarget));
        }
        
        /// <summary>Deletes a PositionTarget record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(positionTargetRow[positionTargetTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.PositionTarget.Delete(adoTransaction, sqlTransaction, rowVersion, modelId, securityId, positionTypeCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.PositionTarget.Archive(adoTransaction);
            // These table lock(s) are required for the 'Archive' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.PositionTarget));
        }
        
        /// <summary>Archives a PositionTarget record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(positionTargetRow[positionTargetTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.PositionTarget.Archive(adoTransaction, sqlTransaction, rowVersion, modelId, securityId, positionTypeCode);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           he method
                ...
                if ((remoteMethod.HasExceptions == false))
                {
                    ...
                    rowVersion = ((long)(positionTargetRow[positionTargetTable.RowVersionColumn]));
                    // Call the internal method to complete the operation.
                    Shadows.WebService.Core.PositionTarget.Archive(transaction, modelId, securityId, positionTypeCode, rowVersion);
                }
            }
