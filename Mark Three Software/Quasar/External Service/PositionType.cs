...
namespace MarkThree.Quasar.External
{
    ...
    public class PositionType
    {
        ...
        static PositionType()
        {
            ...
            ServerDataModel.PositionTypeLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            PositionType.externalKeyArray = new DataView[] {
                    positionTypeTable.UKPositionTypeExternalId0,
                    positionTypeTable.UKPositionTypeExternalId1,
                    positionTypeTable.UKPositionTypeExternalId2,
                    positionTypeTable.UKPositionTypeExternalId3};
            // The table must be released after the array is constructed.
            ServerDataModel.PositionTypeLock.ReleaseReaderLock();
        }
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.PositionType.Insert(adoTransaction);
            MarkThree.Quasar.Core.PositionType.Update(adoTransaction);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.PositionType.Delete(adoTransaction);
        ...
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(positionTypeRow[positionTypeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.PositionType.Delete(adoTransaction, sqlTransaction, rowVersion, positionTypeCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.PositionType.Archive(adoTransaction);
