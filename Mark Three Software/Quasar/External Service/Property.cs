...
namespace MarkThree.Quasar.External
{
    ...
    public class Property
    {
        ...
        static Property()
        {
            ...
            ServerDataModel.PropertyLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            Property.externalKeyArray = new DataView[] {
                    propertyTable.UKPropertyExternalId0,
                    propertyTable.UKPropertyExternalId1,
                    propertyTable.UKPropertyExternalId2,
                    propertyTable.UKPropertyExternalId3};
            // The table must be released after the array is constructed.
            ServerDataModel.PropertyLock.ReleaseReaderLock();
        }
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.Property.Insert(adoTransaction);
            MarkThree.Quasar.Core.Property.Update(adoTransaction);
            // These table lock(s) are required for the 'Load' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Property));
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Property.Delete(adoTransaction);
        ...
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(propertyRow[propertyTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Property.Delete(adoTransaction, sqlTransaction, rowVersion, propertyCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Property.Archive(adoTransaction);
