...
namespace MarkThree.Quasar.External
{
    ...
    public class Scheme : Object
    {
        ...
        public new static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.Scheme.Insert(adoTransaction);
            MarkThree.Quasar.Core.Scheme.Update(adoTransaction);
        ...
        /// <summary>Loads a Scheme record using Metadata Parameters.</summary>
        ...
        public new static void Load(ParameterList parameters)
        {
            ...
            string externalSchemeId = parameters["schemeId"];
            object externalTypeCode = parameters["typeCode"].Value;
            // The row versioning is largely disabled for external operations.  The value is returned to the caller in the
            // event it's needed for operations within the batch.
            long rowVersion = long.MinValue;
            // Resolve External Identifiers
            int schemeId = Object.FindKey(configurationId, "schemeId", externalSchemeId);
            ...
            if ((schemeRow == null))
            {
                ...
                int externalKeyIndex = Scheme.GetExternalKeyIndex(configurationId, "schemeId");
                object[] externalIdArray = new object[8];
                externalIdArray[externalKeyIndex] = externalSchemeId;
                ...
                MarkThree.Quasar.Core.Scheme.Insert(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, externalId2, externalId3, externalId4, externalId5, externalId6, externalId7, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, typeCode);
            }
            else
            {
                ...
                rowVersion = ((long)(schemeRow[schemeTable.RowVersionColumn]));
                // Call the internal method to complete the operation.
                MarkThree.Quasar.Core.Scheme.Update(adoTransaction, sqlTransaction, ref rowVersion, description, null, null, null, null, null, null, null, null, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, schemeId, typeCode);
            }
            // Return values.
        ...
        /// <summary>Updates a Scheme record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public new static void Update(ParameterList parameters)
        {
            ...
            object readOnly = parameters["readOnly"].Value;
            object worldPermission = parameters["worldPermission"].Value;
            string externalSchemeId = ((string)(parameters["schemeId"]));
            object externalTypeCode = parameters["typeCode"].Value;
            // The row versioning is largely disabled for external operations.  The value is returned to the caller in the
            // event it's needed for operations within the batch.
            long rowVersion = long.MinValue;
            // Resolve External Identifiers
            int schemeId = Object.FindRequiredKey(configurationId, "schemeId", externalSchemeId);
            object typeCode = Type.FindOptionalKey(configurationId, "typeCode", externalTypeCode);
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Scheme.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Scheme));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Deletes a Scheme record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public new static void Delete(ParameterList parameters)
        {
            ...
            // identifier is used to determine if a record exists with the same key.
            int schemeId = Scheme.FindRequiredKey(configurationId, "schemeId", externalSchemeId);
            // This disables the concurrency checking logic by finding the current row version and passing it to the
            // internal method.
            ServerDataModel.SchemeRow schemeRow = schemeTable.FindBySchemeId(schemeId);
            rowVersion = ((long)(schemeRow[schemeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Scheme.Delete(adoTransaction, sqlTransaction, rowVersion, schemeId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Scheme.Archive(adoTransaction);
            // These table lock(s) are required for the 'Archive' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Scheme));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Archives a Scheme record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public new static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(schemeRow[schemeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Scheme.Archive(adoTransaction, sqlTransaction, rowVersion, schemeId);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           summary>Collects the table lock request(s) for an 'Archive' operation</summary>
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            Shadows.WebService.Core.Scheme.Archive(transaction);
            // These table lock(s) are required for the 'Archive' operation.
            transaction.Locks.AddReaderLock(ServerDataModel.SchemeLock);
        ...
        public new static void Archive(Transaction transaction, RemoteMethod remoteMethod)
        {
            try
            {
                ...
                string externalSchemeId = remoteMethod.Parameters.GetRequiredString("schemeId");
                ...
                if ((remoteMethod.HasExceptions == false))
                {
                    ...
                    rowVersion = ((long)(schemeRow[schemeTable.RowVersionColumn]));
                    // Call the internal method to complete the operation.
                    Shadows.WebService.Core.Scheme.Archive(transaction, schemeId, rowVersion);
                }
            }
