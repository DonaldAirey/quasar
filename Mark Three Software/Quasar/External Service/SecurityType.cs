...
namespace MarkThree.Quasar.External
{
    ...
    public class SecurityType
    {
        ...
        static SecurityType()
        {
            ...
            ServerDataModel.SecurityTypeLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            SecurityType.externalKeyArray = new DataView[] {
                    securityTypeTable.UKSecurityTypeExternalId0,
                    securityTypeTable.UKSecurityTypeExternalId1,
                    securityTypeTable.UKSecurityTypeExternalId2,
                    securityTypeTable.UKSecurityTypeExternalId3};
            // The table must be released after the array is constructed.
            ServerDataModel.SecurityTypeLock.ReleaseReaderLock();
        }
        ...
        /// <summary>Finds a a SecurityType record using a configuration and an external identifier.</summary>
        /// <param name="configurationId">Specified which mappings (user id columns) to use when looking up external identifiers.</param>
        /// <param name="parameterId">The name of the parameter as specified in the configuration table.</param>
        ...
        public static int FindKey(object configurationId, string parameterId, object externalId)
        {
            ...
            int externalKeyIndex = SecurityType.GetExternalKeyIndex(configurationId, parameterId);
            System.Data.DataView externalKeyView = SecurityType.externalKeyArray[externalKeyIndex];
            ...
            return ((int)(externalKeyView[recordIndex].Row[securityTypeTable.SecurityTypeCodeColumn]));
        }
        ...
        public static int FindRequiredKey(object configurationId, string parameterId, string externalId)
        {
            ...
            int internalId = SecurityType.FindKey(configurationId, parameterId, externalId);
            if ((internalId == int.MinValue))
            {
                throw new Exception(string.Format("The SecurityType table does not have a record identified by \'{0}\'", externalId));
            }
        ...
        public static object FindOptionalKey(object configurationId, string parameterId, object externalId)
        {
            ...
            if ((externalId != null))
            {
                internalId = SecurityType.FindKey(configurationId, parameterId, ((string)(externalId)));
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.SecurityType.Insert(adoTransaction);
            MarkThree.Quasar.Core.SecurityType.Update(adoTransaction);
        ...
        /// <summary>Loads a SecurityType record using Metadata Parameters.</summary>
        ...
        public static void Load(ParameterList parameters)
        {
            ...
            if ((securityTypeRow == null))
            {
                ...
                MarkThree.Quasar.Core.SecurityType.Insert(adoTransaction, sqlTransaction, ref rowVersion, securityTypeCode, description, externalId0, externalId1, externalId2, externalId3);
            }
            else
            {
                // This will bypass the optimistic concurrency checking required by the internal method.
                rowVersion = ((long)(securityTypeRow[securityTypeTable.RowVersionColumn]));
                // Call the internal 'Update' method to complete the operation.
                MarkThree.Quasar.Core.SecurityType.Update(adoTransaction, sqlTransaction, ref rowVersion, securityTypeCode, description, externalId0, externalId1, externalId2, externalId3);
            }
            // Return values
        ...
        /// <summary>Updates a SecurityType record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Update(ParameterList parameters)
        {
            ...
            MarkThree.Quasar.Core.SecurityType.Update(adoTransaction, sqlTransaction, ref rowVersion, securityTypeCode, description, null, null, null, null);
            // Return values.
            parameters["rowVersion"] = rowVersion;
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.SecurityType.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.SecurityType));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Deletes a SecurityType record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(securityTypeRow[securityTypeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.SecurityType.Delete(adoTransaction, sqlTransaction, rowVersion, securityTypeCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.SecurityType.Archive(adoTransaction);
            // These table lock(s) are required for the 'Archive' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.SecurityType));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Archives a SecurityType record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(securityTypeRow[securityTypeTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.SecurityType.Archive(adoTransaction, sqlTransaction, rowVersion, securityTypeCode);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              