...
namespace MarkThree.Quasar.External
{
    ...
    public class Status
    {
        ...
        static Status()
        {
            ...
            ServerDataModel.StatusLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            Status.externalKeyArray = new DataView[] {
                    statusTable.UKStatusExternalId0,
                    statusTable.UKStatusExternalId1,
                    statusTable.UKStatusExternalId2,
                    statusTable.UKStatusExternalId3};
            // The table must be released after the array is constructed.
            ServerDataModel.StatusLock.ReleaseReaderLock();
        }
        ...
        /// <summary>Finds a a Status record using a configuration and an external identifier.</summary>
        /// <param name="configurationId">Specified which mappings (user id columns) to use when looking up external identifiers.</param>
        /// <param name="parameterId">The name of the parameter as specified in the configuration table.</param>
        ...
        public static int FindKey(object configurationId, string parameterId, object externalId)
        {
            ...
            int externalKeyIndex = Status.GetExternalKeyIndex(configurationId, parameterId);
            System.Data.DataView externalKeyView = Status.externalKeyArray[externalKeyIndex];
            ...
            return ((int)(externalKeyView[recordIndex].Row[statusTable.StatusCodeColumn]));
        }
        ...
        public static int FindRequiredKey(object configurationId, string parameterId, string externalId)
        {
            ...
            int internalId = Status.FindKey(configurationId, parameterId, externalId);
            if ((internalId == int.MinValue))
            {
                throw new Exception(string.Format("The Status table does not have a record identified by \'{0}\'", externalId));
            }
        ...
        public static object FindOptionalKey(object configurationId, string parameterId, object externalId)
        {
            ...
            if ((externalId != null))
            {
                internalId = Status.FindKey(configurationId, parameterId, ((string)(externalId)));
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.Status.Insert(adoTransaction);
            MarkThree.Quasar.Core.Status.Update(adoTransaction);
            // These table lock(s) are required for the 'Load' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Status));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Loads a Status record using Metadata Parameters.</summary>
        ...
        public static void Load(ParameterList parameters)
        {
            ...
            if ((statusRow == null))
            {
                ...
                MarkThree.Quasar.Core.Status.Insert(adoTransaction, sqlTransaction, ref rowVersion, statusCode, mnemonic, description, externalId0, externalId1, externalId2, externalId3);
            }
            else
            {
                // This will bypass the optimistic concurrency checking required by the internal method.
                rowVersion = ((long)(statusRow[statusTable.RowVersionColumn]));
                // Call the internal 'Update' method to complete the operation.
                MarkThree.Quasar.Core.Status.Update(adoTransaction, sqlTransaction, ref rowVersion, statusCode, mnemonic, description, externalId0, externalId1, externalId2, externalId3);
            }
            // Return values
        ...
        /// <summary>Updates a Status record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Update(ParameterList parameters)
        {
            ...
            MarkThree.Quasar.Core.Status.Update(adoTransaction, sqlTransaction, ref rowVersion, statusCode, mnemonic, description, null, null, null, null);
            // Return values.
            parameters["rowVersion"] = rowVersion;
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Status.Delete(adoTransaction);
            // These table lock(s) are required for the 'Delete' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Status));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Deletes a Status record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(statusRow[statusTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Status.Delete(adoTransaction, sqlTransaction, rowVersion, statusCode);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.Status.Archive(adoTransaction);
            // These table lock(s) are required for the 'Archive' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Status));
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.Configuration));
        }
        
        /// <summary>Archives a Status record using Metadata Parameters.</summary>
        /// <param name="transaction">Contains the parameters and exceptions for this command.</param>
        public static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(statusRow[statusTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.Status.Archive(adoTransaction, sqlTransaction, rowVersion, statusCode);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  