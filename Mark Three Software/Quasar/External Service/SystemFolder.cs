...
namespace MarkThree.Quasar.External
{
    ...
    public class SystemFolder : Folder
    {
        ...
        public new static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.SystemFolder.Insert(adoTransaction);
            MarkThree.Quasar.Core.SystemFolder.Update(adoTransaction);
        ...
        public new static void Load(ParameterList parameters)
        {
            ...
            if ((systemFolderRow == null))
            {
                ...
                MarkThree.Quasar.Core.SystemFolder.Insert(adoTransaction, sqlTransaction, ref rowVersion, description, externalId0, externalId1, externalId2, externalId3, externalId4, externalId5, externalId6, externalId7, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, typeCode);
            }
            else
            {
                ...
                // Call the internal method to complete the operation.
                MarkThree.Quasar.Core.SystemFolder.Update(adoTransaction, sqlTransaction, ref rowVersion, description, null, null, null, null, null, null, null, null, groupPermission, hidden, name, owner, ownerPermission, readOnly, worldPermission, systemFolderId, typeCode);
            }
            // Return values.
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.SystemFolder.Delete(adoTransaction);
        ...
        public new static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(systemFolderRow[systemFolderTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.SystemFolder.Delete(adoTransaction, sqlTransaction, rowVersion, systemFolderId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.SystemFolder.Archive(adoTransaction);
        ...
        public new static void Archive(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(systemFolderRow[systemFolderTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.SystemFolder.Archive(adoTransaction, sqlTransaction, rowVersion, systemFolderId);
        }
    }
}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               