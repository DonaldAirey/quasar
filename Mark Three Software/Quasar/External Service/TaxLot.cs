...
namespace MarkThree.Quasar.External
{
    ...
    public class TaxLot
    {
        ...
        static TaxLot()
        {
            ...
            ServerDataModel.TaxLotLock.AcquireReaderLock(System.Threading.Timeout.Infinite);
            ...
            TaxLot.externalKeyArray = new DataView[] {
                    taxLotTable.UKTaxLotExternalId0,
                    taxLotTable.UKTaxLotExternalId1,
                    taxLotTable.UKTaxLotExternalId2,
                    taxLotTable.UKTaxLotExternalId3};
            // The table must be released after the array is constructed.
            ServerDataModel.TaxLotLock.ReleaseReaderLock();
        }
        ...
        public static void Load(AdoTransaction adoTransaction)
        {
            ...
            MarkThree.Quasar.Core.TaxLot.Insert(adoTransaction);
            MarkThree.Quasar.Core.TaxLot.Update(adoTransaction);
            // These table lock(s) are required for the 'Load' operation.
            adoTransaction.LockRequests.Add(new TableReaderRequest(ServerDataModel.TaxLot));
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.TaxLot.Delete(adoTransaction);
        ...
        public static void Delete(ParameterList parameters)
        {
            ...
            rowVersion = ((long)(taxLotRow[taxLotTable.RowVersionColumn]));
            // Call the internal method to complete the operation.
            MarkThree.Quasar.Core.TaxLot.Delete(adoTransaction, sqlTransaction, rowVersion, taxLotId);
        }
        ...
        {
            // Call the internal methods to lock the tables required for an insert or update operation.
            MarkThree.Quasar.Core.TaxLot.Archive(adoTransaction);
