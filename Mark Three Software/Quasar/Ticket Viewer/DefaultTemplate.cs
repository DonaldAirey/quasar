...
{
	/// <summary>
	/// Summary description for DefaultBlotter.
	/// </summary>
	class DefaultStylesheet
	{
		...
		public static string XMLData {get {return xmlData;}}

		static DefaultStylesheet()
		{

			DefaultStylesheet.xmlData = @"<?xml version=""1.0"" encoding=""UTF-8"" standalone=""yes""?>
	...
	<xsl:template match=""Execution"">
		...
		<ss:Row ss:Height=""12"">
			...
			<ss:Cell ss:Index=""8"" ss:Formula=""=EquityCommission(RC6)"">
				<xsl:attribute name=""ss:StyleID"">EditPrice</xsl:attribute>
				<ss:Data ss:Type=""Number"">0</ss:Data>
			</ss:Cell>
			<ss:Cell ss:Index=""9"">
				<xsl:if test=""../../@transactionTypeCode=3"">
					<xsl:attribute name=""ss:Formula"">=SECFee(RC6*RC7, 15.0 / 1000000)</xsl:attribute>
				</xsl:if>
				<xsl:attribute name=""ss:StyleID"">EditPrice</xsl:attribute>
				<ss:Data ss:Type=""Number"">0</ss:Data>
			</ss:Cell>
	...
	<!-- A Blank line for new executions -->
	<xsl:template match=""PartialExecution"">
