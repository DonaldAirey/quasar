namespace MarkThree.MiddleTier
{
	...
	public class Delete : ServerMethod
	{
			...
			: base(tableSchema)
		{
			...
			foreach (TableSchema childTable in this.TableSchema.Descendants)
			...
			this.Comments.Add(new CodeCommentStatement(string.Format("Deletes a {0} record.", this.TableSchema.Name), true));
			this.Comments.Add(new CodeCommentStatement("</summary>", true));
			...
			TableSchema rootTable = this.TableSchema.RootTable;
			...
			string rowType = string.Format("{0}.{1}Row", this.ServerSchema.Name, rootTable.Name);
